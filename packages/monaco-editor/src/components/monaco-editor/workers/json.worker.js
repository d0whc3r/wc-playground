...
})(
  {
    ...
    gSd8: [
      function(require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          ...
          (function(e) {
            (e.create = function(e, t) {
              ...
              (e.is = function(e) {
                var t = e;
                return J.objectLiteral(t) && J.number(t.line) && J.number(t.character);
              });
          })(e || (exports.Position = e = {})),
          (exports.Range = t),
          (function(t) {
            (t.create = function(t, n, r, i) {
              if (J.number(t) && J.number(n) && J.number(r) && J.number(i)) return { start: e.create(t, n), end: e.create(r, i) };
              if (e.is(t) && e.is(n)) return { start: t, end: n };
              throw new Error('Range#create called with invalid arguments[' + t + ', ' + n + ', ' + r + ', ' + i + ']');
            }),
              (t.is = function(t) {
                var n = t;
                return J.objectLiteral(n) && e.is(n.start) && e.is(n.end);
              });
          })(t || (exports.Range = t = {})),
          (exports.Location = n),
          (function(e) {
            (e.create = function(e, t) {
              ...
              (e.is = function(e) {
                var n = e;
                return J.defined(n) && t.is(n.range) && (J.string(n.uri) || J.undefined(n.uri));
              });
            ...
            (e.create = function(e, t, n, r) {
              ...
              (e.is = function(e) {
                ...
                return (
                  J.defined(n) &&
                  t.is(n.targetRange) &&
                  J.string(n.targetUri) &&
                  (t.is(n.targetSelectionRange) || J.undefined(n.targetSelectionRange)) &&
                  (t.is(n.originSelectionRange) || J.undefined(n.originSelectionRange))
                );
              });
          ...
          (function(e) {
            (e.create = function(e, t, n, r) {
              ...
              (e.is = function(e) {
                var t = e;
                return J.number(t.red) && J.number(t.green) && J.number(t.blue) && J.number(t.alpha);
              });
          })(i || (exports.Color = i = {})),
          ...
          (function(e) {
            (e.create = function(e, t, n) {
              ...
              (e.is = function(e) {
                ...
                return (
                  J.string(t.label) &&
                  (J.undefined(t.textEdit) || l.is(t)) &&
                  (J.undefined(t.additionalTextEdits) || J.typedArray(t.additionalTextEdits, l.is))
                );
              });
          ...
          (function(e) {
            (e.create = function(e, t, n, r, i) {
              ...
              return J.defined(n) && (o.startCharacter = n), J.defined(r) && (o.endCharacter = r), J.defined(i) && (o.kind = i), o;
            }),
              (e.is = function(e) {
                var t = e;
                return (
          ...
          (function(e) {
            (e.create = function(e, t) {
              ...
              (e.is = function(e) {
                var t = e;
                return J.defined(t) && n.is(t.location) && J.string(t.message);
              });
          ...
          (function(e) {
            (e.create = function(e, t, n, r, i, o) {
              ...
              return (
                J.defined(n) && (s.severity = n),
                J.defined(r) && (s.code = r),
                J.defined(i) && (s.source = i),
                J.defined(o) && (s.relatedInformation = o),
                s
              );
            }),
              (e.is = function(e) {
                ...
                return (
                  ...
                  t.is(n.range) &&
                  J.string(n.message) &&
                  (J.number(n.severity) || J.undefined(n.severity)) &&
                  (J.number(n.code) || J.string(n.code) || J.undefined(n.code)) &&
                  (J.string(n.source) || J.undefined(n.source)) &&
                  (J.undefined(n.relatedInformation) || J.typedArray(n.relatedInformation, u.is))
                );
              });
          ...
          (function(e) {
            (e.create = function(e, t) {
              ...
              return J.defined(n) && n.length > 0 && (i.arguments = n), i;
            }),
              (e.is = function(e) {
                var t = e;
          ...
          (function(e) {
            (e.replace = function(e, t) {
              ...
              (e.is = function(e) {
                var n = e;
                return J.objectLiteral(n) && J.string(n.newText) && t.is(n.range);
              });
          ...
          (function(e) {
            (e.create = function(e, t) {
              ...
              (e.is = function(e) {
                var t = e;
                return J.defined(t) && y.is(t.textDocument) && Array.isArray(t.edits);
              });
            ...
            (e.create = function(e, t) {
              ...
              (e.is = function(e) {
                ...
                return (
                  ...
                  J.string(t.uri) &&
                  (void 0 === t.options ||
                    ((void 0 === t.options.overwrite || J.boolean(t.options.overwrite)) &&
                      (void 0 === t.options.ignoreIfExists || J.boolean(t.options.ignoreIfExists))))
                );
              });
            ...
            (e.create = function(e, t) {
              ...
              (e.is = function(e) {
                ...
                return (
                  ...
                  J.string(t.uri) &&
                  (void 0 === t.options ||
                    ((void 0 === t.options.recursive || J.boolean(t.options.recursive)) &&
                      (void 0 === t.options.ignoreIfNotExists || J.boolean(t.options.ignoreIfNotExists))))
                );
              });
              ...
              return (
                ...
                (void 0 === t.documentChanges ||
                  t.documentChanges.every(function(e) {
                    return J.string(e.kind) ? m.is(e) || h.is(e) || v.is(e) : x.is(e);
                  }))
              );
            };
              ...
              (e.prototype.getTextEditChange = function(e) {
                if (y.is(e)) {
                  ...
                  if (!(r = this._textEditChanges[t.uri])) {
                    ...
                    this._workspaceEdit.documentChanges.push(n), (r = new j(i)), (this._textEditChanges[t.uri] = r);
                  }
                  return r;
                }
                ...
                if (!(r = this._textEditChanges[e])) {
                  var i = [];
                  (this._workspaceEdit.changes[e] = i), (r = new j(i)), (this._textEditChanges[e] = r);
                }
                return r;
              }),
              (e.prototype.createFile = function(e, t) {
                this.checkDocumentChanges(), this._workspaceEdit.documentChanges.push(m.create(e, t));
              }),
              (e.prototype.renameFile = function(e, t, n) {
                this.checkDocumentChanges(), this._workspaceEdit.documentChanges.push(h.create(e, t, n));
              }),
        ...
        (exports.WorkspaceChange = K),
          ...
          (function(e) {
            (e.create = function(e, t) {
              ...
              (e.is = function(e) {
                var t = e;
                return J.defined(t) && J.string(t.uri) && (null === t.version || J.number(t.version));
              });
          ...
          (function(e) {
            (e.create = function(e, t, n, r) {
              ...
              (e.is = function(e) {
                var t = e;
                return J.defined(t) && J.string(t.uri) && J.string(t.languageId) && J.number(t.version) && J.string(t.text);
              });
          ...
          (function(e) {
            e.is = function(e) {
              var t = e;
              return J.objectLiteral(e) && E.is(t.kind) && J.string(t.value);
            };
          ...
          (exports.CompletionItem = T),
          (function(e) {
            e.create = function(e) {
              return { label: e };
            };
          })(T || (exports.CompletionItem = T = {})),
          ...
          (function(e) {
            (e.fromPlainText = function(e) {
              ...
              (e.is = function(e) {
                var t = e;
                return J.string(t) || (J.objectLiteral(t) && J.string(t.language) && J.string(t.value));
              });
          })(S || (exports.MarkedString = S = {})),
          (exports.Hover = R),
          (function(e) {
            e.is = function(e) {
              var n = e;
              return (
                !!n &&
                J.objectLiteral(n) &&
                (I.is(n.contents) || S.is(n.contents) || J.typedArray(n.contents, S.is)) &&
          ...
          (exports.SignatureInformation = A),
          (function(e) {
            e.create = function(e, t) {
              for (var n = [], r = 2; r < arguments.length; r++) n[r - 2] = arguments[r];
              var i = { label: e };
              return J.defined(t) && (i.documentation = t), J.defined(n) ? (i.parameters = n) : (i.parameters = []), i;
            };
          })(A || (exports.SignatureInformation = A = {})),
          (exports.DocumentHighlightKind = F),
          (function(e) {
            (e.Text = 1), (e.Read = 2), (e.Write = 3);
          })(F || (exports.DocumentHighlightKind = F = {})),
          (exports.DocumentHighlight = O),
          (function(e) {
            e.create = function(e, t) {
              var n = { range: e };
              return J.number(t) && (n.kind = t), n;
            };
          })(O || (exports.DocumentHighlight = O = {})),
        ...
        (exports.DocumentSymbol = z),
            ...
            (e.create = function(e, t, n, r, i, o) {
              ...
              (e.is = function(e) {
                ...
                return (
                  ...
                  (void 0 === n.detail || J.string(n.detail)) &&
                  (void 0 === n.deprecated || J.boolean(n.deprecated)) &&
                  (void 0 === n.children || Array.isArray(n.children))
                );
              });
          })(z || (exports.DocumentSymbol = z = {})),
          (exports.CodeActionKind = H),
          (function(e) {
            (e.Empty = ''),
              (e.QuickFix = 'quickfix'),
              (e.Refactor = 'refactor'),
          ...
          })(H || (exports.CodeActionKind = H = {})),
          (exports.CodeActionContext = W),
          (function(e) {
            (e.create = function(e, t) {
              var n = { diagnostics: e };
              ...
              (e.is = function(e) {
                var t = e;
                return J.defined(t) && J.typedArray(t.diagnostics, p.is) && (void 0 === t.only || J.typedArray(t.only, J.string));
              });
          })(W || (exports.CodeActionContext = W = {})),
          (exports.CodeAction = N),
          (function(e) {
            (e.create = function(e, t, n) {
              var r = { title: e };
              return g.is(t) ? (r.command = t) : (r.edit = t), void 0 !== n && (r.kind = n), r;
            }),
              (e.is = function(e) {
                var t = e;
                return (
                  t &&
                  J.string(t.title) &&
                  (void 0 === t.diagnostics || J.typedArray(t.diagnostics, p.is)) &&
                  (void 0 === t.kind || J.string(t.kind)) &&
                  (void 0 !== t.edit || void 0 !== t.command) &&
                  (void 0 === t.command || g.is(t.command)) &&
                  (void 0 === t.edit || b.is(t.edit))
                );
              });
          })(N || (exports.CodeAction = N = {})),
          (exports.CodeLens = U),
          (function(e) {
            (e.create = function(e, t) {
              var n = { range: e };
              ...
              (e.is = function(e) {
                var n = e;
                return J.defined(n) && t.is(n.range) && (J.undefined(n.command) || g.is(n.command));
              });
          })(U || (exports.CodeLens = U = {})),
          (exports.FormattingOptions = V),
          (function(e) {
            (e.create = function(e, t) {
              ...
              (e.is = function(e) {
                var t = e;
                return J.defined(t) && J.number(t.tabSize) && J.boolean(t.insertSpaces);
              });
          })(V || (exports.FormattingOptions = V = {}));
        var q,
          B = (function() {
            return function() {};
          })();
        (exports.DocumentLink = B),
          (function(e) {
            (e.create = function(e, t, n) {
              ...
              (e.is = function(e) {
                var n = e;
                return J.defined(n) && t.is(n.range) && (J.undefined(n.target) || J.string(n.target));
              });
          })(B || (exports.DocumentLink = B = {})),
          (exports.SelectionRange = q),
          (function(e) {
            (e.create = function(e, t) {
              ...
              (e.is = function(n) {
                var r = n;
                return void 0 !== r && t.is(r.range) && (void 0 === r.parent || e.is(r.parent));
              });
          })(q || (exports.SelectionRange = q = {}));
        var Q,
          $,
          G = ['\n', '\r\n', '\r'];
        (exports.EOL = G),
    ...
    jnM8: [
      function(require, module, exports) {
        ...
        function e(e, a) {
          ...
          function A() {
            if (((s = ''), (g = 0), (u = c), (h = f), (C = d), c >= o)) return (u = o), (i = 17);
            var a = e.charCodeAt(c);
            if (r(a)) {
              do {
                c++, (s += String.fromCharCode(a)), (a = e.charCodeAt(c));
              } while (r(a));
              return (i = 15);
            }
            if (t(a)) return c++, (s += String.fromCharCode(a)), 13 === a && 10 === e.charCodeAt(c) && (c++, (s += '\n')), f++, (d = c), (i = 14);
            switch (a) {
              case 123:
                return c++, (i = 1);
              case 125:
                    ...
                    for (var r = '', n = c; ; ) {
                      ...
                      if (92 !== a) {
                        ...
                        switch ((a = e.charCodeAt(c++))) {
                          ...
                          case 117:
                            var s = b(4, !0);
                            s >= 0 ? (r += String.fromCharCode(s)) : (g = 4);
                            break;
                          default:
                            g = 5;
                        }
              ...
              case 47:
                var A = c - 1;
                if (47 === e.charCodeAt(c + 1)) {
                  for (c += 2; c < o && !t(e.charCodeAt(c)); ) c++;
                  return (s = e.substring(A, c)), (i = 12);
                }
                if (42 === e.charCodeAt(c + 1)) {
                  c += 2;
                  for (var k = o - 1, v = !1; c < k; ) {
                    var S = e.charCodeAt(c);
                    if (42 === S && 47 === e.charCodeAt(c + 1)) {
                      (c += 2), (v = !0);
                      break;
                    }
                    c++, t(S) && (13 === S && 10 === e.charCodeAt(c) && c++, f++, (d = c));
                  }
                  return v || (c++, (g = 1)), (s = e.substring(A, c)), (i = 13);
                }
                return (s += String.fromCharCode(a)), c++, (i = 16);
              case 45:
                if (((s += String.fromCharCode(a)), ++c === o || !n(e.charCodeAt(c)))) return (i = 16);
              case 48:
              case 49:
              case 50:
              case 51:
              ...
              case 57:
                return (
                  (s += (function() {
                    var r = c;
                    if (48 === e.charCodeAt(c)) c++;
                    else for (c++; c < e.length && n(e.charCodeAt(c)); ) c++;
                    if (c < e.length && 46 === e.charCodeAt(c)) {
                      if (!(++c < e.length && n(e.charCodeAt(c)))) return (g = 3), e.substring(r, c);
                      for (c++; c < e.length && n(e.charCodeAt(c)); ) c++;
                    }
                    var t = c;
                    if (c < e.length && (69 === e.charCodeAt(c) || 101 === e.charCodeAt(c)))
                      if ((((++c < e.length && 43 === e.charCodeAt(c)) || 45 === e.charCodeAt(c)) && c++, c < e.length && n(e.charCodeAt(c)))) {
                        for (c++; c < e.length && n(e.charCodeAt(c)); ) c++;
                        t = c;
                      } else g = 3;
              ...
              default:
                for (; c < o && l(a); ) c++, (a = e.charCodeAt(c));
                if (u !== c) {
                  switch ((s = e.substring(u, c))) {
                    case 'true':
                      return (i = 8);
                    case 'false':
                      return (i = 9);
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.createScanner = e);
      },
      {}
    ],
    ySGY: [
      function(require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.format = r), (exports.isEOL = s);
        var e = require('./scanner.js');
        function r(r, f, o) {
          var c, i, u, g, h;
          if (f) {
            for (g = f.offset, h = g + f.length, u = g; u > 0 && !s(r, u - 1); ) u--;
            for (var v = h; v < r.length && !s(r, v); ) v++;
            (i = r.substring(u, v)), (c = n(i, o));
          } else (i = r), (c = 0), (u = 0), (g = 0), (h = r.length);
          var k,
            l = a(o, r),
            b = !1,
            O = 0;
          k = o.insertSpaces ? t(' ', o.tabSize || 4) : '\t';
          var T = (0, e.createScanner)(i, !1),
            p = !1;
          function x() {
            return l + t(k, c + O);
          }
          function A() {
            var e = T.scan();
            for (b = !1; 15 === e || 14 === e; ) (b = b || 14 === e), (e = T.scan());
            return (p = 16 === e || 0 !== T.getTokenError()), e;
          }
          var S = [];
          function d(e, t, n) {
            !p && t < h && n > g && r.substring(t, n) !== e && S.push({ offset: t, length: n - t, content: e });
          }
          var L = A();
          if (17 !== L) {
            var j = T.getTokenOffset() + u;
            d(t(k, c), u, j);
          }
          for (; 17 !== L; ) {
            for (var z = T.getTokenOffset() + T.getTokenLength() + u, E = A(), M = ''; !b && (12 === E || 13 === E); ) {
              d(' ', z, T.getTokenOffset() + u), (z = T.getTokenOffset() + T.getTokenLength() + u), (M = 12 === E ? x() : ''), (E = A());
            }
            if (2 === E) 1 !== L && (O--, (M = x()));
            else if (4 === E) 3 !== L && (O--, (M = x()));
            else {
              switch (L) {
                case 3:
                case 1:
            ...
            d(M, z, T.getTokenOffset() + u), (L = E);
          }
          return S;
        }
        function t(e, r) {
          for (var t = '', n = 0; n < r; n++) t += e;
          return t;
        }
        function n(e, r) {
          for (var t = 0, n = 0, a = r.tabSize || 4; t < e.length; ) {
            var s = e.charAt(t);
            if (' ' === s) n++;
            else {
              if ('\t' !== s) break;
    ...
    WVPk: [
      function(require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.getLocation = r),
          (exports.parse = t),
          (exports.parseTree = o),
          (exports.findNodeAtLocation = a),
          (exports.getNodePath = i),
          (exports.getNodeValue = f),
          (exports.contains = c),
          (exports.findNodeAtOffset = u),
          (exports.visit = s),
          (exports.stripComments = l);
        var e,
          n = require('./scanner.js');
        function r(e, n) {
          var r = [],
            t = new Object(),
            o = void 0,
            ...
            i = !1;
          function f(e, n, r, t) {
            (a.value = e), (a.offset = n), (a.length = r), (a.type = t), (a.colonOffset = void 0), (o = a);
          }
          try {
            s(e, {
              onObjectBegin: function(e, a) {
                if (n <= e) throw t;
                (o = void 0), (i = n > e), r.push('');
              },
              onObjectProperty: function(e, o, a) {
                if (n < o) throw t;
                if ((f(e, o, a, 'property'), (r[r.length - 1] = e), n <= o + a)) throw t;
              },
              onObjectEnd: function(e, a) {
                if (n <= e) throw t;
                (o = void 0), r.pop();
              },
              onArrayBegin: function(e, a) {
                if (n <= e) throw t;
                (o = void 0), r.push(0);
              },
              onArrayEnd: function(e, a) {
                if (n <= e) throw t;
                (o = void 0), r.pop();
              },
              onLiteralValue: function(e, r, o) {
                if (n < r) throw t;
                if ((f(e, r, o, p(e)), n <= r + o)) throw t;
              },
              onSeparator: function(e, a, f) {
                if (n <= a) throw t;
                if (':' === e && o && 'property' === o.type) (o.colonOffset = a), (i = !1), (o = void 0);
                else if (',' === e) {
                  var c = r[r.length - 1];
                  'number' == typeof c ? (r[r.length - 1] = c + 1) : ((i = !0), (r[r.length - 1] = '')), (o = void 0);
                }
              }
            });
          } catch (c) {
        ...
        function t(n, r, t) {
          void 0 === r && (r = []), void 0 === t && (t = e.DEFAULT);
          var o = null,
            a = [],
            i = [];
          function f(e) {
            Array.isArray(a) ? a.push(e) : o && (a[o] = e);
          }
          return (
            s(
              n,
              {
                ...
                onError: function(e, n, t) {
                  r.push({ error: e, offset: n, length: t });
                }
              },
              t
            ),
        ...
        function o(n, r, t) {
          ...
          s(
            n,
            {
              ...
              onObjectProperty: function(e, n, r) {
                (o = i({ type: 'property', offset: n, length: -1, parent: o, children: [] })).children.push({
                  type: 'string',
                  value: e,
                  offset: n,
                  length: r,
              ...
              onObjectEnd: function(e, n) {
                (o.length = e + n - o.offset), (o = o.parent), a(e + n);
              },
              ...
              onLiteralValue: function(e, n, r) {
                i({ type: p(e), offset: n, length: r, parent: o, value: e }), a(n + r);
              },
              onSeparator: function(e, n, r) {
                'property' === o.type && (':' === e ? (o.colonOffset = n) : ',' === e && a(n));
              },
              onError: function(e, n, t) {
                r.push({ error: e, offset: n, length: t });
              }
          ...
          var f = o.children[0];
          return f && delete f.parent, f;
        }
        function a(e, n) {
          if (e) {
            for (var r = e, t = 0, o = n; t < o.length; t++) {
              var a = o[t];
              if ('string' == typeof a) {
                if ('object' !== r.type || !Array.isArray(r.children)) return;
                for (var i = !1, f = 0, c = r.children; f < c.length; f++) {
                  var u = c[f];
                  if (Array.isArray(u.children) && u.children[0].value === a) {
                    (r = u.children[1]), (i = !0);
                    break;
                  }
                }
                ...
                var s = a;
                if ('array' !== r.type || s < 0 || !Array.isArray(r.children) || s >= r.children.length) return;
                r = r.children[s];
              }
            }
            return r;
        ...
        function f(e) {
          switch (e.type) {
            ...
            case 'object':
              for (var n = Object.create(null), r = 0, t = e.children; r < t.length; r++) {
                var o = t[r],
                  a = o.children[1];
                a && (n[o.children[0].value] = f(a));
              }
              return n;
            case 'null':
            case 'string':
        ...
        function c(e, n, r) {
          return void 0 === r && (r = !1), (n >= e.offset && n < e.offset + e.length) || (r && n === e.offset + e.length);
        }
        function u(e, n, r) {
          if ((void 0 === r && (r = !1), c(e, n, r))) {
            var t = e.children;
            if (Array.isArray(t))
              for (var o = 0; o < t.length && t[o].offset <= n; o++) {
                var a = u(t[o], n, r);
                if (a) return a;
              }
            return e;
        ...
        function s(r, t, o) {
          ...
          var a = (0, n.createScanner)(r, !1);
          function i(e) {
            return e
              ? function() {
                  return e(a.getTokenOffset(), a.getTokenLength(), a.getTokenStartLine(), a.getTokenStartCharacter());
                }
              : function() {
                  return !0;
                };
          ...
          function f(e) {
            return e
              ? function(n) {
                  return e(n, a.getTokenOffset(), a.getTokenLength(), a.getTokenStartLine(), a.getTokenStartCharacter());
                }
              : function() {
                  return !0;
                };
          }
          var c = i(t.onObjectBegin),
            u = f(t.onObjectProperty),
            s = i(t.onObjectEnd),
            l = i(t.onArrayBegin),
            p = i(t.onArrayEnd),
            h = f(t.onLiteralValue),
            g = f(t.onSeparator),
            d = i(t.onComment),
            v = f(t.onError),
            y = o && o.disallowComments,
            k = o && o.allowTrailingComma;
          function b() {
            for (;;) {
              var e = a.scan();
          ...
          function T(e, n, r) {
            if ((void 0 === n && (n = []), void 0 === r && (r = []), v(e), n.length + r.length > 0))
              for (var t = a.getToken(); 17 !== t; ) {
                if (-1 !== n.indexOf(t)) {
                  b();
                  break;
                }
                if (-1 !== r.indexOf(t)) break;
                t = b();
              }
          }
          function A(e) {
            var n = a.getTokenValue();
            return e ? h(n) : u(n), b(), !0;
          }
          function O() {
            switch (a.getToken()) {
              case 3:
                return (function() {
                  l(), b();
                  for (var e = !1; 4 !== a.getToken() && 17 !== a.getToken(); ) {
                    if (5 === a.getToken()) {
                      if ((e || T(4, [], []), g(','), b(), 4 === a.getToken() && k)) break;
                    } else e && T(6, [], []);
                    O() || T(4, [], [4, 5]), (e = !0);
                  }
                  return p(), 4 !== a.getToken() ? T(8, [4], []) : b(), !0;
                })();
              case 1:
                return (function() {
                  c(), b();
                  for (var e = !1; 2 !== a.getToken() && 17 !== a.getToken(); ) {
                    if (5 === a.getToken()) {
                      if ((e || T(4, [], []), g(','), b(), 2 === a.getToken() && k)) break;
                    } else e && T(6, [], []);
                    (10 !== a.getToken()
                      ? (T(3, [], [2, 5]), 0)
                      : (A(!1), 6 === a.getToken() ? (g(':'), b(), O() || T(4, [], [2, 5])) : T(5, [], [2, 5]), 1)) || T(4, [], [2, 5]),
                      (e = !0);
                  }
                  return s(), 2 !== a.getToken() ? T(7, [2], []) : b(), !0;
                })();
              case 10:
                return A(!0);
              default:
                return (function() {
                  switch (a.getToken()) {
                    case 11:
                      var e = 0;
                      try {
                        'number' != typeof (e = JSON.parse(a.getTokenValue())) && (T(2), (e = 0));
                      } catch (n) {
                        T(2);
                      }
                      h(e);
          ...
          return b(), 17 === a.getToken() || (O() ? (17 !== a.getToken() && T(9, [], []), !0) : (T(4, [], []), !1));
        }
        function l(e, r) {
          var t,
            o,
            a = (0, n.createScanner)(e),
            i = [],
            f = 0;
          do {
            switch (((o = a.getPosition()), (t = a.scan()))) {
              case 12:
              case 13:
              case 17:
                f !== o && i.push(e.substring(f, o)), void 0 !== r && i.push(a.getTokenValue().replace(/[^\r\n]/g, r)), (f = a.getPosition());
            }
          } while (17 !== t);
          return i.join('');
        }
    ...
    me75: [
      function(require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.removeProperty = n),
          (exports.setProperty = r),
          (exports.applyEdit = f),
          (exports.isWS = i);
        var e = require('./format.js'),
          t = require('./parser.js');
        function n(e, t, n) {
          return r(e, t, void 0, n);
        }
        function r(e, n, r, f, i) {
          for (
            var l, s = n.slice(), h = (0, t.parseTree)(e, []), g = void 0, c = void 0;
            s.length > 0 && ((c = s.pop()), void 0 === (g = (0, t.findNodeAtLocation)(h, s)) && void 0 !== r);

          )
            'string' == typeof c ? (((l = {})[c] = r), (r = l)) : (r = [r]);
          if (g) {
            if ('object' === g.type && 'string' == typeof c && Array.isArray(g.children)) {
              var d = (0, t.findNodeAtLocation)(g, [c]);
              if (void 0 !== d) {
                if (void 0 === r) {
                  if (!d.parent) throw new Error('Malformed AST');
                  var a = g.children.indexOf(d.parent),
                    p = void 0,
                    u = d.parent.offset + d.parent.length;
                  if (a > 0) p = (A = g.children[a - 1]).offset + A.length;
                  else if (((p = g.offset + 1), g.children.length > 1)) u = g.children[1].offset;
                  return o(e, { offset: p, length: u - p, content: '' }, f);
                }
                return o(e, { offset: d.offset, length: d.length, content: JSON.stringify(r) }, f);
              }
              if (void 0 === r) return [];
              var v = JSON.stringify(c) + ': ' + JSON.stringify(r),
                y = i
                  ? i(
                      g.children.map(function(e) {
              ...
              return o(
                ...
                (m =
                  y > 0
                    ? { offset: (A = g.children[y - 1]).offset + A.length, length: 0, content: ',' + v }
                    : 0 === g.children.length
                    ? { offset: g.offset + 1, length: 0, content: v }
                    : { offset: g.offset + 1, length: 0, content: v + ',' }),
                f
              );
            }
            if ('array' === g.type && 'number' == typeof c && Array.isArray(g.children)) {
              if (-1 === c) {
                (v = '' + JSON.stringify(r)), (m = void 0);
                if (0 === g.children.length) m = { offset: g.offset + 1, length: 0, content: v };
                else m = { offset: (A = g.children[g.children.length - 1]).offset + A.length, length: 0, content: ',' + v };
                return o(e, m, f);
              }
              if (void 0 === r && g.children.length >= 0) {
                var O = c,
                  x = g.children[O];
                m = void 0;
                if (1 === g.children.length) m = { offset: g.offset + 1, length: g.length - 2, content: '' };
                else if (g.children.length - 1 === O) {
                  var A,
                    w = (A = g.children[O - 1]).offset + A.length;
                  m = { offset: w, length: g.offset + g.length - 2 - w, content: '' };
                } else m = { offset: x.offset, length: g.children[O + 1].offset - x.offset, content: '' };
                return o(e, m, f);
              }
              throw new Error('Array modification not supported yet');
            }
            throw new Error('Can not add ' + ('number' != typeof c ? 'index' : 'property') + ' to parent of type ' + g.type);
          }
          if (void 0 === r) throw new Error('Can not delete in empty document');
          return o(e, { offset: h ? h.offset : 0, length: h ? h.length : 0, content: JSON.stringify(r) }, f);
        }
        function o(t, n, r) {
          var o = f(t, n),
            i = n.offset,
            l = n.offset + n.content.length;
          if (0 === n.length || 0 === n.content.length) {
            for (; i > 0 && !(0, e.isEOL)(o, i - 1); ) i--;
            for (; l < o.length && !(0, e.isEOL)(o, l); ) l++;
          }
          for (var s = (0, e.format)(o, { offset: i, length: l - i }, r), h = s.length - 1; h >= 0; h--) {
            var g = s[h];
            (o = f(o, g)), (i = Math.min(i, g.offset)), (l = Math.max(l, g.offset + g.length)), (l += g.content.length - g.length);
          }
          return [{ offset: i, length: t.length - (o.length - l) - i, content: o.substring(i, l) }];
        }
        function f(e, t) {
      ...
      { './format.js': 'ySGY', './parser.js': 'WVPk' }
    ],
    RBdm: [
      function(require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.printParseErrorCode = m),
          (exports.format = g),
          (exports.modify = O),
          (exports.applyEdits = E),
        ...
        var e = a(require('./impl/format.js')),
          r = a(require('./impl/edit.js')),
          t = a(require('./impl/scanner.js')),
          n = a(require('./impl/parser.js'));
        function o() {
          if ('function' != typeof WeakMap) return null;
          var e = new WeakMap();
          return (
        ...
        var s = t.createScanner;
        exports.createScanner = s;
        var p = n.getLocation;
        ...
        var c = n.parseTree;
        exports.parseTree = c;
        var d = n.findNodeAtLocation;
        exports.findNodeAtLocation = d;
        var u = n.findNodeAtOffset;
        exports.findNodeAtOffset = u;
        var f = n.getNodePath;
        exports.getNodePath = f;
        var x = n.getNodeValue;
        exports.getNodeValue = x;
        var l = n.visit;
        exports.visit = l;
        var v = n.stripComments;
        function m(e) {
          switch (e) {
            case 1:
        ...
        exports.stripComments = v;
      },
      { './impl/format.js': 'ySGY', './impl/edit.js': 'me75', './impl/scanner.js': 'jnM8', './impl/parser.js': 'WVPk' }
    ],
    UAsT: [
      function(require, module, exports) {
        'use strict';
        function r(e, t) {
          ...
          if (Array.isArray(e)) {
            ...
            var u = [];
            for (o in t) u.push(o);
            if ((u.sort(), !r(i, u))) return !1;
            for (n = 0; n < i.length; n++) if (!r(e[i[n]], t[i[n]])) return !1;
          }
          return !0;
        }
        function e(r) {
    ...
    QWB0: [
      function(require, module, exports) {
        ...
        var e,
          t,
          n = require('./_deps/vscode-languageserver-types/main.js');
        (exports.ErrorCode = e),
          (function(e) {
          ...
          (exports.ClientCapabilities = t),
          (function(e) {
            e.LATEST = { textDocument: { completion: { completionItem: { documentationFormat: [n.MarkupKind.Markdown, n.MarkupKind.PlainText] } } } };
          })(t || (exports.ClientCapabilities = t = {}));
      },
      { './_deps/vscode-languageserver-types/main.js': 'gSd8' }
    ],
    M4HU: [
      function(require, module, exports) {
        'use strict';
    ...
    KNHO: [
      function(require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.asSchema = b),
          (exports.newJSONDocument = S),
          (exports.getNodeValue = k),
          (exports.getNodePath = O),
          (exports.contains = N),
          (exports.parse = W),
        ...
        var e = a(require('../../jsonc-parser/main.js')),
          t = require('../utils/objects.js'),
          r = require('../jsonLanguageTypes.js'),
          n = a(require('../../../fillers/vscode-nls.js')),
          o = require('../_deps/vscode-languageserver-types/main.js');
        function i() {
          if ('function' != typeof WeakMap) return null;
          var e = new WeakMap();
          return (
        ...
        var s = (function() {
          ...
          u = {
            'color-hex': {
              errorMessage: l('colorHexFormatWarning', 'Invalid color format. Use #RGB, #RGBA, #RRGGBB or #RRGGBBAA.'),
              pattern: /^#([0-9A-Fa-f]{3,4}|([0-9A-Fa-f]{2}){3,4})$/
            },
            'date-time': {
              errorMessage: l('dateTimeFormatWarning', 'String is not a RFC3339 date-time.'),
              pattern: /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i
            },
            date: {
              errorMessage: l('dateFormatWarning', 'String is not a RFC3339 date.'),
              pattern: /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/i
            },
            time: {
              errorMessage: l('timeFormatWarning', 'String is not a RFC3339 time.'),
              pattern: /^([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i
            },
            email: {
              errorMessage: l('emailFormatWarning', 'String is not an e-mail address.'),
        ...
        function b(e) {
          return (0, t.isBoolean)(e) ? (e ? {} : { not: {} }) : e;
        }
        (exports.ObjectASTNodeImpl = y),
          (exports.EnumMatch = v),
          (function(e) {
            (e[(e.Key = 0)] = 'Key'), (e[(e.Enum = 1)] = 'Enum');
          })(v || (exports.EnumMatch = v = {}));
        var x = (function() {
            function e(e, t) {
            ...
            return (
              ...
              (e.prototype.include = function(e) {
                return (-1 === this.focusOffset || N(e, this.focusOffset)) && e !== this.exclude;
              }),
              ...
              (e.prototype.mergeEnumValues = function(e) {
                if (!this.enumValueMatch && !e.enumValueMatch && this.enumValues && e.enumValues) {
                  ...
                  for (var t = 0, n = this.problems; t < n.length; t++) {
                    var o = n[t];
                    o.code === r.ErrorCode.EnumValueMismatch &&
                      (o.message = l(
                        'enumWarning',
        ...
        function k(t) {
          return e.getNodeValue(t);
        }
        function O(t) {
          return e.getNodePath(t);
        }
        function N(e, t, r) {
          return void 0 === r && (r = !1), (t >= e.offset && t < e.offset + e.length) || (r && t === e.offset + e.length);
        }
        exports.ValidationResult = E;
        var V = (function() {
          function t(e, t, r) {
            void 0 === t && (t = []), void 0 === r && (r = []), (this.root = e), (this.syntaxErrors = t), (this.comments = r);
          }
          return (
            (t.prototype.getNodeFromOffset = function(t, r) {
              if ((void 0 === r && (r = !1), this.root)) return e.findNodeAtOffset(this.root, t, r);
            }),
            ...
            (t.prototype.validate = function(e, t) {
              if (this.root && t) {
                var r = new E();
                return (
                  T(this.root, t, r, M.instance),
                  r.problems.map(function(t) {
                    var r = o.Range.create(e.positionAt(t.location.offset), e.positionAt(t.location.offset + t.location.length));
                    return o.Diagnostic.create(r, t.message, t.severity, t.code);
                  })
                );
              }
              return null;
            }),
            (t.prototype.getMatchingSchemas = function(e, t, r) {
              void 0 === t && (t = -1), void 0 === r && (r = null);
              var n = new x(t, r);
              return this.root && e && T(this.root, e, new E(), n), n.schemas;
            }),
            t
          );
        })();
        function T(e, n, i, a) {
          if (e && a.include(e)) {
            switch (e.type) {
              case 'object':
                !(function(e, r, n, i) {
                  for (var a = Object.create(null), s = [], u = 0, c = e.properties; u < c.length; u++) {
                    var p = c[u],
                      f = p.keyNode.value;
                    (a[f] = p.valueNode), s.push(f);
                  }
                  if (Array.isArray(r.required))
                    for (var m = 0, g = r.required; m < g.length; m++) {
                      var h = g[m];
                      if (!a[h]) {
                        var d = e.parent && 'property' === e.parent.type && e.parent.keyNode,
                          v = d ? { offset: d.offset, length: d.length } : { offset: e.offset, length: 1 };
                        n.problems.push({
                          location: v,
                          severity: o.DiagnosticSeverity.Warning,
                          message: l('MissingRequiredPropWarning', 'Missing property "{0}".', h)
                        });
                      }
                    }
                  var y = function(e) {
                    for (var t = s.indexOf(e); t >= 0; ) s.splice(t, 1), (t = s.indexOf(e));
                  };
                  if (r.properties)
                    for (var x = 0, S = Object.keys(r.properties); x < S.length; x++) {
                      var h = S[x];
                      y(h);
                      var k = r.properties[h],
                        O = a[h];
                      if (O)
                        if ((0, t.isBoolean)(k))
                          if (k) n.propertiesMatches++, n.propertiesValueMatches++;
                            ...
                            n.problems.push({
                              ...
                              severity: o.DiagnosticSeverity.Warning,
                              message: r.errorMessage || l('DisallowedExtraPropWarning', 'Property {0} is not allowed.', h)
                            });
                          }
                        else {
                          var N = new E();
                          T(O, k, N, i), n.mergePropertyMatch(N);
                        }
                    }
                  if (r.patternProperties)
                    for (var V = 0, W = Object.keys(r.patternProperties); V < W.length; V++)
                      for (var P = W[V], w = new RegExp(P), A = 0, I = s.slice(0); A < I.length; A++) {
                        var h = I[A];
                        if (w.test(h)) {
                          y(h);
                          var O = a[h];
                          if (O) {
                            var k = r.patternProperties[P];
                            if ((0, t.isBoolean)(k))
                              if (k) n.propertiesMatches++, n.propertiesValueMatches++;
                              else {
                                var p = O.parent;
                  ...
                  if ('object' == typeof r.additionalProperties)
                    for (var C = 0, D = s; C < D.length; C++) {
                      ...
                      if (O) {
                        var N = new E();
                        T(O, r.additionalProperties, N, i), n.mergePropertyMatch(N);
                      }
                    }
                  else if (!1 === r.additionalProperties && s.length > 0)
                    for (var j = 0, R = s; j < R.length; j++) {
                      var h = R[j],
                        O = a[h];
                      if (O) {
                        var p = O.parent;
                  ...
                  (0, t.isNumber)(r.maxProperties) &&
                    e.properties.length > r.maxProperties &&
                    n.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('MaxPropWarning', 'Object has more properties than limit of {0}.', r.maxProperties)
                    });
                  (0, t.isNumber)(r.minProperties) &&
                    e.properties.length < r.minProperties &&
                    n.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('MinPropWarning', 'Object has fewer properties than the required number of {0}', r.minProperties)
                    });
                  if (r.dependencies)
                    for (var U = 0, q = Object.keys(r.dependencies); U < q.length; U++) {
                      var f = q[U],
                        B = a[f];
                      if (B) {
                        var F = r.dependencies[f];
                        if (Array.isArray(F))
                          for (var L = 0, _ = F; L < _.length; L++) {
                            ...
                            a[J]
                              ...
                              : n.problems.push({
                                  location: { offset: e.offset, length: e.length },
                                  severity: o.DiagnosticSeverity.Warning,
                                  message: l('RequiredDependentPropWarning', 'Object is missing property {0} required by property {1}.', J, f)
                                });
                          }
                        else {
                          var k = b(F);
                          if (k) {
                            var N = new E();
                            T(e, k, N, i), n.mergePropertyMatch(N);
                          }
                        }
                      }
                    }
                  var G = b(r.propertyNames);
                  if (G)
                    for (var K = 0, $ = e.properties; K < $.length; K++) {
                      var Z = $[K],
                        f = Z.keyNode;
                      f && T(f, G, n, M.instance);
                    }
                })(e, n, i, a);
                break;
              case 'array':
                !(function(e, r, n, i) {
                  if (Array.isArray(r.items)) {
                    for (var a = r.items, s = 0; s < a.length; s++) {
                      var u = a[s],
                        c = b(u),
                        p = new E(),
                        f = e.items[s];
                      f ? (T(f, c, p, i), n.mergePropertyMatch(p)) : e.items.length >= a.length && n.propertiesValueMatches++;
                    }
                    if (e.items.length > a.length)
                      if ('object' == typeof r.additionalItems)
                        for (var m = a.length; m < e.items.length; m++) {
                          var p = new E();
                          T(e.items[m], r.additionalItems, p, i), n.mergePropertyMatch(p);
                        }
                      else
                        !1 === r.additionalItems &&
                          n.problems.push({
                            location: { offset: e.offset, length: e.length },
                            severity: o.DiagnosticSeverity.Warning,
                            message: l('additionalItemsWarning', 'Array has too many items according to schema. Expected {0} or fewer.', a.length)
                          });
                  } else {
                    var g = b(r.items);
                    if (g)
                      for (var h = 0, d = e.items; h < d.length; h++) {
                        var f = d[h],
                          p = new E();
                        T(f, g, p, i), n.mergePropertyMatch(p);
                      }
                  }
                  var v = b(r.contains);
                  if (v) {
                    var y = e.items.some(function(e) {
                      var t = new E();
                      return T(e, v, t, M.instance), !t.hasProblems();
                    });
                    y ||
                      n.problems.push({
                        location: { offset: e.offset, length: e.length },
                        severity: o.DiagnosticSeverity.Warning,
                        message: r.errorMessage || l('requiredItemMissingWarning', 'Array does not contain required item.')
                      });
                  }
                  (0, t.isNumber)(r.minItems) &&
                    e.items.length < r.minItems &&
                    n.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('minItemsWarning', 'Array has too few items. Expected {0} or more.', r.minItems)
                    });
                  (0, t.isNumber)(r.maxItems) &&
                    e.items.length > r.maxItems &&
                    n.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('maxItemsWarning', 'Array has too many items. Expected {0} or fewer.', r.maxItems)
                    });
                  if (!0 === r.uniqueItems) {
                    var x = k(e),
                      S = x.some(function(e, t) {
                    ...
                    S &&
                      n.problems.push({
                        location: { offset: e.offset, length: e.length },
                        severity: o.DiagnosticSeverity.Warning,
                        message: l('uniqueItemsWarning', 'Array has duplicate items.')
                      });
                  }
                })(e, n, i, a);
                break;
              case 'string':
                !(function(e, r, n, i) {
                  (0, t.isNumber)(r.minLength) &&
                    e.value.length < r.minLength &&
                    n.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('minLengthWarning', 'String is shorter than the minimum length of {0}.', r.minLength)
                    });
                  (0, t.isNumber)(r.maxLength) &&
                    e.value.length > r.maxLength &&
                    n.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('maxLengthWarning', 'String is longer than the maximum length of {0}.', r.maxLength)
                    });
                  if ((0, t.isString)(r.pattern)) {
                    ...
                    a.test(e.value) ||
                      n.problems.push({
                        ...
                        severity: o.DiagnosticSeverity.Warning,
                        message:
                          r.patternErrorMessage || r.errorMessage || l('patternWarning', 'String does not match the pattern of "{0}".', r.pattern)
                      });
                  }
                  if (r.format)
                    switch (r.format) {
                      ...
                      case 'uri-reference':
                        ...
                        if (e.value) {
                          var c = /^(([^:\/?#]+?):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/.exec(e.value);
                          c
                            ? c[2] || 'uri' !== r.format || (s = l('uriSchemeMissing', 'URI with a scheme is expected.'))
                            : (s = l('uriMissing', 'URI is expected.'));
                        } else s = l('uriEmpty', 'URI expected.');
                        s &&
                          n.problems.push({
                            location: { offset: e.offset, length: e.length },
                            severity: o.DiagnosticSeverity.Warning,
                            message: r.patternErrorMessage || r.errorMessage || l('uriFormatWarning', 'String is not a URI: {0}', s)
                          });
                        break;
                      case 'color-hex':
                      case 'date-time':
                      ...
                      case 'email':
                        var p = u[r.format];
                        (e.value && p.pattern.exec(e.value)) ||
                          n.problems.push({
                            location: { offset: e.offset, length: e.length },
                            severity: o.DiagnosticSeverity.Warning,
                            message: r.patternErrorMessage || r.errorMessage || p.errorMessage
                          });
                    }
                })(e, n, i);
                break;
              case 'number':
                !(function(e, r, n, i) {
                  var a = e.value;
                  (0, t.isNumber)(r.multipleOf) &&
                    a % r.multipleOf != 0 &&
                    n.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('multipleOfWarning', 'Value is not divisible by {0}.', r.multipleOf)
                    });
                  function s(e, r) {
                    return (0, t.isNumber)(r) ? r : (0, t.isBoolean)(r) && r ? e : void 0;
                  }
                  function u(e, r) {
                    if (!(0, t.isBoolean)(r) || !r) return e;
                  }
                  var c = s(r.minimum, r.exclusiveMinimum);
                  (0, t.isNumber)(c) &&
                    a <= c &&
                    n.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('exclusiveMinimumWarning', 'Value is below the exclusive minimum of {0}.', c)
                    });
                  var p = s(r.maximum, r.exclusiveMaximum);
                  (0, t.isNumber)(p) &&
                    a >= p &&
                    n.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('exclusiveMaximumWarning', 'Value is above the exclusive maximum of {0}.', p)
                    });
                  var f = u(r.minimum, r.exclusiveMinimum);
                  (0, t.isNumber)(f) &&
                    a < f &&
                    n.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('minimumWarning', 'Value is below the minimum of {0}.', f)
                    });
                  var m = u(r.maximum, r.exclusiveMaximum);
                  (0, t.isNumber)(m) &&
                    a > m &&
                    n.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('maximumWarning', 'Value is above the maximum of {0}.', m)
                    });
                })(e, n, i);
                break;
              case 'property':
                return T(e.valueNode, n, i, a);
            }
            !(function() {
              function s(t) {
              ...
              Array.isArray(n.type)
                ? n.type.some(s) ||
                  i.problems.push({
                    location: { offset: e.offset, length: e.length },
                    severity: o.DiagnosticSeverity.Warning,
                    message: n.errorMessage || l('typeArrayMismatchWarning', 'Incorrect type. Expected one of {0}.', n.type.join(', '))
                  })
                : n.type &&
                  (s(n.type) ||
                    i.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: n.errorMessage || l('typeMismatchWarning', 'Incorrect type. Expected "{0}".', n.type)
                    }));
              if (Array.isArray(n.allOf))
                for (var u = 0, c = n.allOf; u < c.length; u++) {
                  var p = c[u];
                  T(e, b(p), i, a);
                }
              var f = b(n.not);
                ...
                T(e, f, m, g),
                  m.hasProblems() ||
                    i.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('notSchemaWarning', 'Matches a schema that is not allowed.')
                    });
                for (var h = 0, d = g.schemas; h < d.length; h++) {
                  var v = d[h];
                  (v.inverted = !v.inverted), a.add(v);
                }
              }
              var y = function(t, r) {
                for (var n = [], s = null, u = 0, c = t; u < c.length; u++) {
                  var p = c[u],
                    f = b(p),
                    m = new E(),
                    g = a.newSub();
                  if ((T(e, f, m, g), m.hasProblems() || n.push(f), s))
                    if (r || m.hasProblems() || s.validationResult.hasProblems()) {
                      var h = m.compare(s.validationResult);
                      h > 0
                        ? (s = { schema: f, validationResult: m, matchingSchemas: g })
                        : 0 === h && (s.matchingSchemas.merge(g), s.validationResult.mergeEnumValues(m));
                    } else
                      s.matchingSchemas.merge(g),
                        (s.validationResult.propertiesMatches += m.propertiesMatches),
                        (s.validationResult.propertiesValueMatches += m.propertiesValueMatches);
                  else s = { schema: f, validationResult: m, matchingSchemas: g };
                }
                return (
                  n.length > 1 &&
                    r &&
                    i.problems.push({
                      ...
                      severity: o.DiagnosticSeverity.Warning,
                      message: l('oneOfWarning', 'Matches multiple schemas when only one must validate.')
                    }),
                  null !== s &&
                    (i.merge(s.validationResult),
                    (i.propertiesMatches += s.validationResult.propertiesMatches),
                    (i.propertiesValueMatches += s.validationResult.propertiesValueMatches),
                    a.merge(s.matchingSchemas)),
                  n.length
                );
              };
              Array.isArray(n.anyOf) && y(n.anyOf, !1);
              Array.isArray(n.oneOf) && y(n.oneOf, !0);
              var x = function(t) {
                  var r = new E(),
                    n = a.newSub();
                  T(e, b(t), r, n),
              ...
              M &&
                (function(t, r, n) {
                  var o = b(t),
                    i = new E(),
                    s = a.newSub();
                  T(e, o, i, s), a.merge(s), i.hasProblems() ? n && x(n) : r && x(r);
                })(M, b(n.then), b(n.else));
              if (Array.isArray(n.enum)) {
                for (var S = k(e), O = !1, N = 0, V = n.enum; N < V.length; N++) {
                  var W = V[N];
                  if ((0, t.equals)(S, W)) {
                    O = !0;
                    break;
                ...
                (i.enumValues = n.enum),
                  ...
                  O ||
                    i.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      code: r.ErrorCode.EnumValueMismatch,
                      message:
                        n.errorMessage ||
                        l(
                          'enumWarning',
              ...
              if ((0, t.isDefined)(n.const)) {
                var S = k(e);
                (0, t.equals)(S, n.const)
                  ? (i.enumValueMatch = !0)
                  : (i.problems.push({
                      location: { offset: e.offset, length: e.length },
                      severity: o.DiagnosticSeverity.Warning,
                      code: r.ErrorCode.EnumValueMismatch,
                      message: n.errorMessage || l('constWarning', 'Value must be {0}.', JSON.stringify(n.const))
                    }),
                    (i.enumValueMatch = !1)),
                  (i.enumValues = [n.const]);
              }
              n.deprecationMessage &&
                ...
                i.problems.push({
                  ...
                  severity: o.DiagnosticSeverity.Warning,
                  message: n.deprecationMessage
                });
            })(),
              a.add({ node: e, schema: n });
          }
        }
        function W(n, i) {
          var a = [],
            s = -1,
            u = n.getText(),
            c = e.createScanner(u, !1),
            v = i && i.collectComments ? [] : void 0;
          function b() {
            for (;;) {
              var e = c.scan();
              switch ((E(), e)) {
                case 12:
                case 13:
                  Array.isArray(v) && v.push(o.Range.create(n.positionAt(c.getTokenOffset()), n.positionAt(c.getTokenOffset() + c.getTokenLength())));
                  break;
                case 15:
                case 14:
                  break;
          ...
          function x(e, t, r, i, l) {
            if ((void 0 === l && (l = o.DiagnosticSeverity.Error), 0 === a.length || r !== s)) {
              var u = o.Range.create(n.positionAt(r), n.positionAt(i));
              a.push(o.Diagnostic.create(u, e, l, t, n.languageId)), (s = r);
            }
          }
          function M(e, t, r, n, o) {
            void 0 === r && (r = null), void 0 === n && (n = []), void 0 === o && (o = []);
            var i = c.getTokenOffset(),
              a = c.getTokenOffset() + c.getTokenLength();
            if (i === a && i > 0) {
              for (i--; i > 0 && /\s/.test(u.charAt(i)); ) i--;
              a = i + 1;
            }
            if ((x(e, t, i, a), r && S(r, !1), n.length + o.length > 0))
          ...
          function E() {
            switch (c.getTokenError()) {
              case 4:
                return M(l('InvalidUnicode', 'Invalid unicode sequence in string.'), r.ErrorCode.InvalidUnicode), !0;
              case 5:
                return M(l('InvalidEscapeCharacter', 'Invalid escape character in string.'), r.ErrorCode.InvalidEscapeCharacter), !0;
              case 3:
                return M(l('UnexpectedEndOfNumber', 'Unexpected end of number.'), r.ErrorCode.UnexpectedEndOfNumber), !0;
              case 1:
                return M(l('UnexpectedEndOfComment', 'Unexpected end of comment.'), r.ErrorCode.UnexpectedEndOfComment), !0;
              case 2:
                return M(l('UnexpectedEndOfString', 'Unexpected end of string.'), r.ErrorCode.UnexpectedEndOfString), !0;
              case 6:
                return (
                  M(l('InvalidCharacter', 'Invalid characters in string. Control characters must be escaped.'), r.ErrorCode.InvalidCharacter), !0
                );
            }
            return !1;
          }
          function S(e, t) {
            return (e.length = c.getTokenOffset() + c.getTokenLength() - e.offset), t && b(), e;
          }
          function k(e, t) {
            var i = new d(e, c.getTokenOffset()),
              a = O(i);
            if (!a) {
              if (16 !== c.getToken()) return null;
              M(l('DoubleQuotesExpected', 'Property keys must be doublequoted'), r.ErrorCode.Undefined);
              var s = new h(i, c.getTokenOffset(), c.getTokenLength());
              (s.value = c.getTokenValue()), (a = s), b();
            }
            i.keyNode = a;
            var u = t[a.value];
            if (
              (u
                ? (x(
                    l('DuplicateKeyWarning', 'Duplicate object key'),
                    r.ErrorCode.DuplicateKey,
                    i.keyNode.offset,
              ...
              (i.colonOffset = c.getTokenOffset()), b();
            else if (
              (M(l('ColonExpected', 'Colon expected'), r.ErrorCode.ColonExpected),
              10 === c.getToken() && n.positionAt(a.offset + a.length).line < n.positionAt(c.getTokenOffset()).line)
            )
              return (i.length = a.length), i;
            var p = N(i, a.value);
            return p
              ? ((i.valueNode = p), (i.length = p.offset + p.length - i.offset), i)
              : M(l('ValueExpected', 'Value expected'), r.ErrorCode.ValueExpected, i, [], [2, 5]);
          }
          function O(e) {
            if (10 !== c.getToken()) return null;
            var t = new h(e, c.getTokenOffset());
            return (t.value = c.getTokenValue()), S(t, !0);
          }
          function N(e, n) {
            return (
              (function(e) {
                if (3 !== c.getToken()) return null;
                var t = new m(e, c.getTokenOffset());
                b();
                for (var n = 0, o = !1; 4 !== c.getToken() && 17 !== c.getToken(); ) {
                  if (5 === c.getToken()) {
                    o || M(l('ValueExpected', 'Value expected'), r.ErrorCode.ValueExpected);
                    var i = c.getTokenOffset();
                    if ((b(), 4 === c.getToken())) {
                      o && x(l('TrailingComma', 'Trailing comma'), r.ErrorCode.TrailingComma, i, i + 1);
                      continue;
                    }
                  } else o && M(l('ExpectedComma', 'Expected comma'), r.ErrorCode.CommaExpected);
                  var a = N(t, n++);
                  a ? t.items.push(a) : M(l('PropertyExpected', 'Value expected'), r.ErrorCode.ValueExpected, null, [], [4, 5]), (o = !0);
                }
                return 4 !== c.getToken()
                  ? M(l('ExpectedCloseBracket', 'Expected comma or closing bracket'), r.ErrorCode.CommaOrCloseBacketExpected, t)
                  : S(t, !0);
              })(e) ||
              (function(e) {
                if (1 !== c.getToken()) return null;
                var t = new y(e, c.getTokenOffset()),
                  n = Object.create(null);
                b();
                for (var o = !1; 2 !== c.getToken() && 17 !== c.getToken(); ) {
                  if (5 === c.getToken()) {
                    o || M(l('PropertyExpected', 'Property expected'), r.ErrorCode.PropertyExpected);
                    var i = c.getTokenOffset();
                    if ((b(), 2 === c.getToken())) {
                      o && x(l('TrailingComma', 'Trailing comma'), r.ErrorCode.TrailingComma, i, i + 1);
                      continue;
                  ...
                  var a = k(t, n);
                  a ? t.properties.push(a) : M(l('PropertyExpected', 'Property expected'), r.ErrorCode.PropertyExpected, null, [], [2, 5]), (o = !0);
                }
                return 2 !== c.getToken()
                  ? M(l('ExpectedCloseBrace', 'Expected comma or closing brace'), r.ErrorCode.CommaOrCloseBraceExpected, t)
                  : S(t, !0);
              })(e) ||
              O(e) ||
              (function(e) {
                if (11 !== c.getToken()) return null;
                var n = new g(e, c.getTokenOffset());
                if (0 === c.getTokenError()) {
                  var o = c.getTokenValue();
                  try {
                    var i = JSON.parse(o);
                    if (!(0, t.isNumber)(i)) return M(l('InvalidNumberFormat', 'Invalid number format.'), r.ErrorCode.Undefined, n);
                    n.value = i;
                  } catch (a) {
                    return M(l('InvalidNumberFormat', 'Invalid number format.'), r.ErrorCode.Undefined, n);
                  }
                  n.isInteger = -1 === o.indexOf('.');
                }
                return S(n, !0);
              })(e) ||
              (function(e) {
                switch (c.getToken()) {
                  case 7:
                    return S(new p(e, c.getTokenOffset()), !0);
                  case 8:
                    return S(new f(e, !0, c.getTokenOffset()), !0);
                  case 9:
                    return S(new f(e, !1, c.getTokenOffset()), !0);
                  default:
                    return null;
                }
              })(e)
          ...
          return (
            17 !== b() &&
              ((T = N(null))
                ? 17 !== c.getToken() && M(l('End of file expected', 'End of file expected.'), r.ErrorCode.Undefined)
                : M(l('Invalid symbol', 'Expected a JSON object, array or literal.'), r.ErrorCode.Undefined)),
            new V(T, a, v)
          );
        }
        exports.JSONDocument = V;
      },
      {
        '../../jsonc-parser/main.js': 'RBdm',
        '../utils/objects.js': 'UAsT',
        '../jsonLanguageTypes.js': 'QWB0',
        ...
        function r(e, t, n) {
          if (null !== e && 'object' == typeof e) {
            ...
            if (Array.isArray(e)) {
              ...
              for (var f = '[\n', l = 0; l < e.length; l++) (f += i + r(e[l], i, n)), l < e.length - 1 && (f += ','), (f += '\n');
              return (f += t + ']');
            }
            var u = Object.keys(e);
            ...
            for (f = '{\n', l = 0; l < u.length; l++) {
              var o = u[l];
              (f += i + JSON.stringify(o) + ': ' + r(e[o], i, n)), l < u.length - 1 && (f += ','), (f += '\n');
            }
            return (f += t + '}');
          }
          return n(e);
        }
        Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.stringifyObject = r);
      },
      {}
    ],
    PlBB: [
      function(require, module, exports) {
        ...
        function n(e, t) {
          for (var r = ''; t > 0; ) 1 == (1 & t) && (r += e), (e += e), (t >>>= 1);
          return r;
        }
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.startsWith = e),
          (exports.endsWith = t),
          (exports.convertSimple2RegExpPattern = r),
          (exports.repeat = n);
      },
      {}
    ],
    IScR: [
      function(require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.JSONCompletion = void 0);
        var e = l(require('../parser/jsonParser.js')),
          t = l(require('../../jsonc-parser/main.js')),
          r = require('../utils/json.js'),
          n = require('../utils/strings.js'),
          o = require('../utils/objects.js'),
          i = require('../_deps/vscode-languageserver-types/main.js'),
          a = l(require('../../../fillers/vscode-nls.js'));
        function s() {
          if ('function' != typeof WeakMap) return null;
          var e = new WeakMap();
          return (
        ...
        var u = a.loadMessageBundle(),
          p = (function() {
            ...
            return (
              (a.prototype.doResolve = function(e) {
              ...
              (a.prototype.doComplete = function(t, r, n) {
                var o = this,
                  a = { items: [], isIncomplete: !1 },
                  s = t.offsetAt(r),
                  l = n.getNodeFromOffset(s, !0);
                if (this.isInComment(t, l ? l.offset : 0, s)) return Promise.resolve(a);
                var u = this.getCurrentWord(t, s),
                  p = null;
                if (!l || ('string' !== l.type && 'number' !== l.type && 'boolean' !== l.type && 'null' !== l.type)) {
                  var c = s - u.length;
                  c > 0 && '"' === t.getText()[c - 1] && c--, (p = i.Range.create(t.positionAt(c), r));
                } else p = i.Range.create(t.positionAt(l.offset), t.positionAt(l.offset + l.length));
                var d = {},
                  f = {
                    add: function(e) {
                      var t = d[e.label];
                      t
                        ...
                        : ((d[e.label] = e), p && (e.textEdit = i.TextEdit.replace(p, e.insertText)), a.items.push(e));
                    },
                ...
                return this.schemaService.getSchemaForResource(t.uri, n).then(function(r) {
                  var c = [],
                    m = !0,
                    g = '',
                    y = null;
                  if (l && 'string' === l.type) {
                    ...
                    h &&
                      'property' === h.type &&
                      h.keyNode === l &&
                      ((m = !h.valueNode), (y = h), (g = t.getText().substr(l.offset + 1, l.length - 2)), h && (l = h.parent));
                  }
                  if (l && 'object' === l.type) {
                    if (l.offset === s) return a;
                    l.properties.forEach(function(e) {
                      (y && y === e) || (d[e.keyNode.value] = i.CompletionItem.create('__'));
                    });
                    var v = '';
                    m && (v = o.evaluateSeparatorAfter(t, t.offsetAt(p.end))),
                      r ? o.getPropertyCompletions(r, n, l, m, v, f) : o.getSchemaLessPropertyCompletions(n, l, g, f);
                    var x = e.getNodePath(l);
                    o.contributions.forEach(function(e) {
                      var r = e.collectPropertyCompletions(t.uri, x, u, m, '' === v, f);
                      r && c.push(r);
                    }),
                      !r &&
                        u.length > 0 &&
                        '"' !== t.getText().charAt(s - u.length - 1) &&
                        (f.add({
                          kind: i.CompletionItemKind.Property,
                          label: o.getLabelForValue(u),
                          insertText: o.getInsertTextForProperty(u, null, !1, v),
                  ...
                  var T = {};
                  return (
                    r ? o.getValueCompletions(r, n, l, s, t, f, T) : o.getSchemaLessValueCompletions(n, l, s, t, f),
                    o.contributions.length > 0 && o.getContributedValueCompletions(n, l, s, t, f, c),
                    o.promiseConstructor.all(c).then(function() {
                      if (0 === f.getNumberOfProposals()) {
                        var e = s;
                        !l || ('string' !== l.type && 'number' !== l.type && 'boolean' !== l.type && 'null' !== l.type) || (e = l.offset + l.length);
                        var r = o.evaluateSeparatorAfter(t, e);
                        o.addFillerValueCompletions(T, r, f);
                      }
                      return a;
                    })
                  );
              ...
              (a.prototype.getPropertyCompletions = function(e, t, r, o, a, s) {
                var l = this;
                    ...
                    t &&
                      Object.keys(t).forEach(function(e) {
                        ...
                        if ('object' == typeof r && !r.deprecationMessage && !r.doNotSuggest) {
                          var u = {
                            kind: i.CompletionItemKind.Property,
                            label: l.sanitizeLabel(e),
                            insertText: l.getInsertTextForProperty(e, r, o, a),
                            insertTextFormat: i.InsertTextFormat.Snippet,
                            filterText: l.getFilterTextForValue(e),
                            documentation: l.fromMarkup(r.markdownDescription) || r.description || ''
                          };
                          (0, n.endsWith)(u.insertText, '$1' + a) && (u.command = { title: 'Suggest', command: 'editor.action.triggerSuggest' }),
                            s.add(u);
                        }
                      });
                  }
              ...
              (a.prototype.getSchemaLessPropertyCompletions = function(e, t, r, n) {
                var o = this,
                  a = function(e) {
              ...
              (a.prototype.getSchemaLessValueCompletions = function(t, r, n, o, a) {
                var s = this,
                  l = n;
                if (
                  (!r ||
                    ('string' !== r.type && 'number' !== r.type && 'boolean' !== r.type && 'null' !== r.type) ||
                    ((l = r.offset + r.length), (r = r.parent)),
                  !r)
                )
                  return (
                    a.add({
                ...
                var u = this.evaluateSeparatorAfter(o, l),
                  p = function(t) {
                    e.contains(t.parent, n, !0) ||
                      a.add({
                        kind: s.getSuggestionKind(t.type),
                        label: s.getLabelTextForMatchingNode(t, o),
                        insertText: s.getInsertTextForMatchingNode(t, o, u),
                        insertTextFormat: i.InsertTextFormat.Snippet,
                        documentation: ''
                      }),
                      'boolean' === t.type && s.addBooleanValueCompletion(!t.value, u, a);
                  };
                if ('property' === r.type && n > r.colonOffset) {
                  var c = r.valueNode;
                  if (c && (n > c.offset + c.length || 'object' === c.type || 'array' === c.type)) return;
                  var d = r.keyNode.value;
                  t.visit(function(e) {
                    return 'property' === e.type && e.keyNode.value === d && e.valueNode && p(e.valueNode), !0;
                  }),
                    '$schema' === d && r.parent && !r.parent.parent && this.addDollarSchemaCompletions(u, a);
                }
                if ('array' === r.type)
                  if (r.parent && 'property' === r.parent.type) {
                    var f = r.parent.keyNode.value;
                    t.visit(function(e) {
                      return (
                        'property' === e.type && e.keyNode.value === f && e.valueNode && 'array' === e.valueNode.type && e.valueNode.items.forEach(p),
                        !0
                      );
                    });
                  } else r.items.forEach(p);
              }),
              (a.prototype.getValueCompletions = function(e, t, r, n, o, i, a) {
                var s = this,
                  l = n,
                  u = null,
                  p = null;
                if (
                  (!r ||
                    ('string' !== r.type && 'number' !== r.type && 'boolean' !== r.type && 'null' !== r.type) ||
                    ((l = r.offset + r.length), (p = r), (r = r.parent)),
                  r)
                ) {
                  if ('property' === r.type && n > r.colonOffset) {
                    var c = r.valueNode;
                  ...
                  if (r && (null !== u || 'array' === r.type)) {
                    var d = this.evaluateSeparatorAfter(o, l);
                    t.getMatchingSchemas(e.schema, r.offset, p).forEach(function(e) {
                      if (e.node === r && !e.inverted && e.schema) {
                        if ('array' === r.type && e.schema.items)
                          if (Array.isArray(e.schema.items)) {
                            var t = s.findItemAtOffset(r, o, n);
                        ...
                        if (e.schema.properties) {
                          var l = e.schema.properties[u];
                          l && s.addSchemaValueCompletions(l, d, i, a);
                        }
                      }
                    }),
                      '$schema' !== u || r.parent || this.addDollarSchemaCompletions(d, i),
              ...
              (a.prototype.getContributedValueCompletions = function(t, r, n, o, i, a) {
                if (r) {
                  if (
                    (('string' !== r.type && 'number' !== r.type && 'boolean' !== r.type && 'null' !== r.type) || (r = r.parent),
                    'property' === r.type && n > r.colonOffset)
                  ) {
                    var s = r.keyNode.value,
                      l = r.valueNode;
                    if (!l || n <= l.offset + l.length) {
                      var u = e.getNodePath(r.parent);
              ...
              (a.prototype.addSchemaValueCompletions = function(e, t, r, n) {
                var o = this;
                'object' == typeof e &&
              ...
              (a.prototype.addDefaultValueCompletions = function(e, t, r, n) {
                var a = this;
                void 0 === n && (n = 0);
                var s = !1;
                if ((0, o.isDefined)(e.default)) {
                  for (var l = e.type, p = e.default, c = n; c > 0; c--) (p = [p]), (l = 'array');
                  r.add({
                    kind: this.getSuggestionKind(l),
                    label: this.getLabelForValue(p),
                    insertText: this.getInsertTextForValue(p, t),
                    insertTextFormat: i.InsertTextFormat.Snippet,
                    detail: u('json.suggest.default', 'Default value')
                  }),
                    (s = !0);
                }
                Array.isArray(e.examples) &&
                  e.examples.forEach(function(o) {
                    for (var l = e.type, u = o, p = n; p > 0; p--) (u = [u]), (l = 'array');
                    r.add({
                      kind: a.getSuggestionKind(l),
                      label: a.getLabelForValue(u),
                      insertText: a.getInsertTextForValue(u, t),
                      insertTextFormat: i.InsertTextFormat.Snippet
                    }),
                      (s = !0);
                  }),
                  Array.isArray(e.defaultSnippets) &&
                    e.defaultSnippets.forEach(function(l) {
                      var u,
                        p,
                        c = e.type,
                        d = l.body,
                      ...
                      if ((0, o.isDefined)(d)) {
                        e.type;
                        for (var m = n; m > 0; m--) (d = [d]), 'array';
                        (u = a.getInsertTextForSnippetValue(d, t)), (p = a.getFilterTextForSnippetValue(d)), (f = f || a.getLabelForSnippetValue(d));
                      } else if ('string' == typeof l.bodyText) {
                        var g = '',
                          y = '',
                          h = '';
                        for (m = n; m > 0; m--) (g = g + h + '[\n'), (y = y + '\n' + h + ']'), (h += '\t'), (c = 'array');
                        (u = g + h + l.bodyText.split('\n').join('\n' + h) + y + t), (f = f || a.sanitizeLabel(u)), (p = u.replace(/[\n]/g, ''));
                      }
                      r.add({
                        kind: a.getSuggestionKind(c),
                        label: f,
                        documentation: a.fromMarkup(l.markdownDescription) || l.description,
                        insertText: u,
                        insertTextFormat: i.InsertTextFormat.Snippet,
                        filterText: p
                      }),
                  ...
                  s || 'object' != typeof e.items || Array.isArray(e.items) || this.addDefaultValueCompletions(e.items, t, r, n + 1);
              }),
              (a.prototype.addEnumValueCompletions = function(e, t, r) {
                if (
                  ((0, o.isDefined)(e.const) &&
                    r.add({
                  ...
                  for (var n = 0, a = e.enum.length; n < a; n++) {
                    var s = e.enum[n],
                      l = this.fromMarkup(e.markdownDescription) || e.description;
                    e.markdownEnumDescriptions && n < e.markdownEnumDescriptions.length && this.doesSupportMarkdown()
                      ? (l = this.fromMarkup(e.markdownEnumDescriptions[n]))
                      : e.enumDescriptions && n < e.enumDescriptions.length && (l = e.enumDescriptions[n]),
                      r.add({
                        kind: this.getSuggestionKind(e.type),
              ...
              (a.prototype.collectTypes = function(e, t) {
                if (!Array.isArray(e.enum) && !(0, o.isDefined)(e.const)) {
                  var r = e.type;
                  Array.isArray(r)
              ...
              (a.prototype.addFillerValueCompletions = function(e, t, r) {
                e.object &&
                  r.add({
                    kind: this.getSuggestionKind('object'),
                    label: '{}',
                    ...
                    insertTextFormat: i.InsertTextFormat.Snippet,
                    detail: u('defaults.object', 'New object'),
                    documentation: ''
                  }),
                  e.array &&
                    r.add({
                      ...
                      insertText: this.getInsertTextForGuessedValue([], t),
                      insertTextFormat: i.InsertTextFormat.Snippet,
                      detail: u('defaults.array', 'New array'),
                      documentation: ''
                    });
              }),
              (a.prototype.addBooleanValueCompletion = function(e, t, r) {
                r.add({
              ...
              (a.prototype.addNullValueCompletion = function(e, t) {
                t.add({
              ...
              (a.prototype.addDollarSchemaCompletions = function(e, t) {
                var r = this;
                this.schemaService
              ...
              (a.prototype.sanitizeLabel = function(e) {
                return (e = e.replace(/[\n]/g, '↵')).length > 57 && (e = e.substr(0, 57).trim() + '...'), e;
              }),
              (a.prototype.getLabelForValue = function(e) {
                return this.sanitizeLabel(JSON.stringify(e));
              }),
              (a.prototype.getFilterTextForValue = function(e) {
                return JSON.stringify(e);
              }),
              (a.prototype.getFilterTextForSnippetValue = function(e) {
                return JSON.stringify(e).replace(/\$\{\d+:([^}]+)\}|\$\d+/g, '$1');
              }),
              (a.prototype.getLabelForSnippetValue = function(e) {
                var t = JSON.stringify(e);
                return (t = t.replace(/\$\{\d+:([^}]+)\}|\$\d+/g, '$1')), this.sanitizeLabel(t);
              }),
              (a.prototype.getInsertTextForPlainText = function(e) {
                return e.replace(/[\\\$\}]/g, '\\$&');
              }),
              (a.prototype.getInsertTextForValue = function(e, t) {
                var r = JSON.stringify(e, null, '\t');
                return '{}' === r ? '{$1}' + t : '[]' === r ? '[$1]' + t : this.getInsertTextForPlainText(r + t);
              }),
              (a.prototype.getInsertTextForSnippetValue = function(e, t) {
                return (
                  (0, r.stringifyObject)(e, '', function(e) {
                    return 'string' == typeof e && '^' === e[0] ? e.substr(1) : JSON.stringify(e);
                  }) + t
                );
              }),
              (a.prototype.getInsertTextForGuessedValue = function(e, t) {
                switch (typeof e) {
                  case 'object':
              ...
              (a.prototype.getSuggestionKind = function(e) {
                if (Array.isArray(e)) {
                  var t = e;
              ...
              (a.prototype.getLabelTextForMatchingNode = function(e, t) {
                switch (e.type) {
                  case 'array':
                    return '[]';
                  case 'object':
              ...
              (a.prototype.getInsertTextForMatchingNode = function(e, t, r) {
                switch (e.type) {
                  case 'array':
              ...
              (a.prototype.getInsertTextForProperty = function(e, t, r, n) {
                ...
                if (t) {
                  if (Array.isArray(t.defaultSnippets)) {
                    if (1 === t.defaultSnippets.length) {
                      ...
                      (0, o.isDefined)(u) && (a = this.getInsertTextForSnippetValue(u, ''));
                    }
                    l += t.defaultSnippets.length;
                  }
                  if (
                    (t.enum && (a || 1 !== t.enum.length || (a = this.getInsertTextForGuessedValue(t.enum[0], '')), (l += t.enum.length)),
                    (0, o.isDefined)(t.default) && (a || (a = this.getInsertTextForGuessedValue(t.default, '')), l++),
                    0 === l)
                  ) {
                    var p = Array.isArray(t.type) ? t.type[0] : t.type;
                    switch ((p || (t.properties ? (p = 'object') : t.items && (p = 'array')), p)) {
                      case 'boolean':
                        a = '$1';
                        break;
                      case 'string':
                ...
                return (!a || l > 1) && (a = '$1'), s + a + n;
              }),
              (a.prototype.getCurrentWord = function(e, t) {
                for (var r = t - 1, n = e.getText(); r >= 0 && -1 === ' \t\n\r\v":{[,]}'.indexOf(n.charAt(r)); ) r--;
                return n.substring(r + 1, t);
              }),
              (a.prototype.evaluateSeparatorAfter = function(e, r) {
                var n = t.createScanner(e.getText(), !0);
              ...
              (a.prototype.findItemAtOffset = function(e, r, n) {
                for (var o = t.createScanner(r.getText(), !0), i = e.items, a = i.length - 1; a >= 0; a--) {
                  var s = i[a];
                  if (n > s.offset + s.length)
                    return o.setPosition(s.offset + s.length), 5 === o.scan() && n >= o.getTokenOffset() + o.getTokenLength() ? a + 1 : a;
                  if (n >= s.offset) return a;
                }
                return 0;
              }),
              (a.prototype.isInComment = function(e, r, n) {
                var o = t.createScanner(e.getText(), !1);
                o.setPosition(r);
                for (var i = o.scan(); 17 !== i && o.getTokenOffset() + o.getTokenLength() < n; ) i = o.scan();
                return (12 === i || 13 === i) && o.getTokenOffset() <= n;
              }),
              (a.prototype.fromMarkup = function(e) {
                if (e && this.doesSupportMarkdown()) return { kind: i.MarkupKind.Markdown, value: e };
              }),
              (a.prototype.doesSupportMarkdown = function() {
                if (!(0, o.isDefined)(this.supportsMarkdown)) {
                  ...
                  this.supportsMarkdown =
                    ...
                    -1 !== e.completionItem.documentationFormat.indexOf(i.MarkupKind.Markdown);
                }
        ...
        exports.JSONCompletion = p;
      },
      {
        '../parser/jsonParser.js': 'KNHO',
        '../../jsonc-parser/main.js': 'RBdm',
        '../utils/json.js': 'Y2vf',
        '../utils/strings.js': 'PlBB',
        '../utils/objects.js': 'UAsT',
        '../_deps/vscode-languageserver-types/main.js': 'gSd8',
        '../../../fillers/vscode-nls.js': 'M4HU'
      }
    ...
    fp31: [
      function(require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.JSONHover = void 0);
        var e = n(require('../parser/jsonParser.js')),
          r = require('../_deps/vscode-languageserver-types/main.js');
        function t() {
          if ('function' != typeof WeakMap) return null;
          var e = new WeakMap();
          return (
        ...
        var o = (function() {
          function t(e, r, t) {
            void 0 === r && (r = []), (this.schemaService = e), (this.contributions = r), (this.promise = t || Promise);
          }
          return (
            (t.prototype.doHover = function(t, n, o) {
              var u = t.offsetAt(n),
                a = o.getNodeFromOffset(u);
              if (!a || (('object' === a.type || 'array' === a.type) && u > a.offset + 1 && u < a.offset + a.length - 1))
                return this.promise.resolve(null);
              var c = a;
              if ('string' === a.type) {
                var f = a.parent;
                if (f && 'property' === f.type && f.keyNode === a && !(a = f.valueNode)) return this.promise.resolve(null);
              }
              for (
                var p = r.Range.create(t.positionAt(c.offset), t.positionAt(c.offset + c.length)),
                  l = function(e) {
                    return { contents: e, range: p };
                  },
                  h = e.getNodePath(a),
                  m = this.contributions.length - 1;
                m >= 0;
                m--
              ) {
                var v = this.contributions[m].getInfoContribution(t.uri, h);
                if (v)
                  return v.then(function(e) {
                    return l(e);
                  });
              }
              return this.schemaService.getSchemaForResource(t.uri, o).then(function(r) {
                if (r) {
                  var t = o.getMatchingSchemas(r.schema, a.offset),
                    n = null,
                    u = null,
                    c = null,
                    f = null;
                  t.every(function(r) {
                    if (
                      ...
                      !r.inverted &&
                      r.schema &&
                      ((n = n || r.schema.title), (u = u || r.schema.markdownDescription || i(r.schema.description)), r.schema.enum)
                    ) {
                      var t = r.schema.enum.indexOf(e.getNodeValue(a));
                      r.schema.markdownEnumDescriptions
                        ? (c = r.schema.markdownEnumDescriptions[t])
                        : r.schema.enumDescriptions && (c = i(r.schema.enumDescriptions[t])),
                        c && 'string' != typeof (f = r.schema.enum[t]) && (f = JSON.stringify(f));
                    }
                    return !0;
                  });
                  var p = '';
      ...
      { '../parser/jsonParser.js': 'KNHO', '../_deps/vscode-languageserver-types/main.js': 'gSd8' }
    ],
    KZoE: [
      function(require, module, exports) {
        var process = require('process');
        var t = require('process');
        Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.setUriThrowOnMissingScheme = a), (exports.URI = void 0);
        var e,
          r = (function() {
            var t =
              Object.setPrototypeOf ||
          ...
          y = (function() {
            ...
            return (
              ...
              (t.file = function(t) {
                ...
                return new g('file', r, t, p, p);
              }),
              (t.from = function(t) {
                return new g(t.scheme, t.authority, t.path, t.query, t.fragment);
              }),
              (t.prototype.toString = function(t) {
              ...
              (t.revive = function(e) {
                if (e) {
                  if (e instanceof t) return e;
                  var r = new g(e);
                  return (r._formatted = e.external), (r._fsPath = e._sep === v ? e.fsPath : null), r;
                }
                return e;
              }),
              t
          ...
          g = (function(t) {
            ...
            return (
              ...
              (e.prototype.toJSON = function() {
                var t = { $mid: 1 };
                return (
                  this._fsPath && ((t.fsPath = this._fsPath), (t._sep = v)),
                  this._formatted && (t.external = this._formatted),
                  this.path && (t.path = this.path),
                  this.scheme && (t.scheme = this.scheme),
                  this.authority && (t.authority = this.authority),
        ...
        function C(t) {
          for (var e = void 0, r = 0; r < t.length; r++) {
            var o = t.charCodeAt(r);
            35 === o || 63 === o ? (void 0 === e && (e = t.substr(0, r)), (e += b[o])) : void 0 !== e && (e += t[r]);
          }
          return void 0 !== e ? e : t;
        }
        function _(t) {
        ...
        function A(t, e) {
          ...
          return s && ((o += '?'), (o += r(s, !1))), a && ((o += '#'), (o += e ? a : w(a, !1))), o;
        }
      },
      { process: 'mXUW' }
    ],
    VtNB: [
      function(require, module, exports) {
        ...
        var e = o(require('../../jsonc-parser/main.js')),
          t = require('../../vscode-uri/index.js'),
          r = o(require('../utils/strings.js')),
          n = o(require('../parser/jsonParser.js')),
          s = o(require('../../../fillers/vscode-nls.js'));
        function i() {
          if ('function' != typeof WeakMap) return null;
          var e = new WeakMap();
          return (
        ...
        var a = s.loadMessageBundle(),
          c = (function() {
            function e(e) {
              try {
                this.patternRegExp = new RegExp(r.convertSimple2RegExpPattern(e) + '$');
              } catch (t) {
          ...
          h = (function() {
            function e(e, t, r) {
              (this.service = e), (this.url = t), (this.dependencies = {}), r && (this.unresolvedSchema = this.service.promise.resolve(new u(r)));
            }
            return (
        ...
        var l = (function() {
          ...
          return (
            (e.prototype.getSection = function(e) {
              return n.asSchema(this.getSectionRecursive(e, this.schema));
            }),
            (e.prototype.getSectionRecursive = function(e, t) {
              ...
              if (t.patternProperties)
                for (var n = 0, s = Object.keys(t.patternProperties); n < s.length; n++) {
                  var i = s[n];
                ...
                if (r.match('[0-9]+'))
                  if (Array.isArray(t.items)) {
                    var o = parseInt(r, 10);
                    if (!isNaN(o) && t.items[o]) return this.getSectionRecursive(e, t.items[o]);
        ...
        var p = (function() {
          ...
          return (
            (s.prototype.getRegisteredSchemaIds = function(e) {
              return Object.keys(this.registeredSchemasIds).filter(function(r) {
                var n = t.URI.parse(r).scheme;
                return 'schemaservice' !== n && (!e || e(n));
              });
            }),
            Object.defineProperty(s.prototype, 'promise', {
              get: function() {
            ...
            (s.prototype.onResourceChange = function(e) {
              for (
                var t = this,
                  r = !1,
                  n = [(e = this.normalizeId(e))],
                  s = Object.keys(this.schemasById).map(function(e) {
                    return t.schemasById[e];
                  });
                n.length;

              )
                for (var i = n.pop(), o = 0; o < s.length; o++) {
                  var a = s[o];
                  a && (a.url === i || a.dependencies[i]) && (a.url !== i && n.push(a.url), a.clearSchema(), (s[o] = void 0), (r = !0));
                }
              return r;
            }),
            (s.prototype.normalizeId = function(e) {
              try {
                return t.URI.parse(e).toString();
              } catch (r) {
                return e;
              }
            }),
            (s.prototype.setSchemaContributions = function(e) {
              if (e.schemas) {
                var t = e.schemas;
                for (var r in t) {
              ...
              if (e.schemaAssociations) {
                var s = e.schemaAssociations;
                for (var i in s) {
                  var o = s[i];
                  this.contributionAssociations[i] = o;
                  for (var a = this.getOrAddFilePatternAssociation(i), c = 0, h = o; c < h.length; c++) {
                    var u = h[c];
                    r = this.normalizeId(u);
                    a.addSchema(r);
                  }
                }
              }
            }),
            (s.prototype.addSchemaHandle = function(e, t) {
              var r = new h(this, e, t);
              return (this.schemasById[e] = r), r;
            }),
            (s.prototype.getOrAddSchemaHandle = function(e, t) {
              return this.schemasById[e] || this.addSchemaHandle(e, t);
            }),
            (s.prototype.getOrAddFilePatternAssociation = function(e) {
            ...
            (s.prototype.clearExternalSchemas = function() {
              ...
              for (var t in this.contributionAssociations)
                for (var r = this.getOrAddFilePatternAssociation(t), n = 0, s = this.contributionAssociations[t]; n < s.length; n++) {
                  var i = s[n];
                  e = this.normalizeId(i);
                  r.addSchema(e);
                }
            }),
            (s.prototype.getResolvedSchema = function(e) {
              var t = this.normalizeId(e),
                r = this.schemasById[t];
              return r ? r.getResolvedSchema() : this.promise.resolve(null);
            }),
            (s.prototype.loadSchema = function(t) {
              if (!this.requestService) {
                var r = a('json.schema.norequestservice', "Unable to load schema from '{0}'. No schema request service available", f(t));
                return this.promise.resolve(new u({}, [r]));
              }
              return this.requestService(t).then(
                function(r) {
                  if (!r) {
                    var n = a('json.schema.nocontent', "Unable to load schema from '{0}': No content.", f(t));
                    return new u({}, [n]);
                  }
                  var s,
                    i = [];
                  s = e.parse(r, i);
                  var o = i.length
                    ? [a('json.schema.invalidFormat', "Unable to parse content from '{0}': Parse error at offset {1}.", f(t), i[0].offset)]
                    : [];
                  return new u(s, o);
                },
                function(e) {
                  ...
                  return r.length > 1 && (t = r[1]), new u({}, [t]);
                }
              );
            }),
            (s.prototype.resolveSchemaContent = function(e, t, r) {
              var n = this,
                s = e.errors.slice(0),
                i = e.schema,
                ...
                c = function(e, t, r, n) {
                  ...
                  else s.push(a('json.schema.invalidref', "$ref '{0}' in '{1}' can not be resolved.", n, r));
                },
                h = function(e, t, r, i, h) {
                  o && !/^\w+:\/\/.*/.test(t) && (t = o.resolveRelativePath(t, i)), (t = n.normalizeId(t));
                  var l = n.getOrAddSchemaHandle(t);
                  return l.getUnresolvedSchema().then(function(n) {
                    if (((h[t] = !0), n.errors.length)) {
                      var i = r ? t + '#' + r : t;
                      s.push(a('json.schema.problemloadingref', "Problems loading reference '{0}': {1}", i, n.errors[0]));
                    }
                    return c(e, n.schema, t, r), u(e, n.schema, t, l.dependencies);
                  });
                },
                u = function(e, t, r, s) {
                  ...
                  for (
                    var i = [e],
                      ...
                      u = function(e) {
                        for (var n = []; e.$ref; ) {
                          var o = e.$ref,
                            u = o.split('#', 2);
                          if ((delete e.$ref, u[0].length > 0)) return void a.push(h(e, u[0], u[1], r, s));
                          -1 === n.indexOf(o) && (c(e, t, r, u[1]), n.push(o));
                        }
                        !(function() {
                          for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                    ...
                    var l = i.pop();
                    o.indexOf(l) >= 0 || (o.push(l), u(l));
                  }
                  return n.promise.all(a);
                };
              return u(i, i, t, r).then(function(e) {
                return new l(i, s);
              });
            }),
            (s.prototype.getSchemaForResource = function(e, t) {
              if (t && t.root && 'object' === t.root.type) {
                var s = t.root.properties.filter(function(e) {
                  return '$schema' === e.keyNode.value && e.valueNode && 'string' === e.valueNode.type;
                });
                if (s.length > 0) {
                  var i = n.getNodeValue(s[0].valueNode);
                  if ((i && r.startsWith(i, '.') && this.contextService && (i = this.contextService.resolveRelativePath(i, e)), i)) {
                    var o = this.normalizeId(i);
                    return this.getOrAddSchemaHandle(o).getResolvedSchema();
                  }
                }
              }
              for (var a = Object.create(null), c = [], h = 0, u = this.filePatternAssociations; h < u.length; h++) {
                var l = u[h];
                if (l.matchesPattern(e))
                  for (var p = 0, f = l.getSchemas(); p < f.length; p++) {
                    var d = f[p];
                    a[d] || (c.push(d), (a[d] = !0));
                  }
              }
            ...
            (s.prototype.createCombinedSchema = function(e, t) {
        ...
        function f(e) {
          try {
            var r = t.URI.parse(e);
            if ('file' === r.scheme) return r.fsPath;
          } catch (n) {}
          return e;
        }
        exports.JSONSchemaService = p;
      },
      {
        '../../jsonc-parser/main.js': 'RBdm',
    ...
    UH1L: [
      function(require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.JSONValidation = void 0);
        var e = require('./jsonSchemaService.js'),
          r = require('../_deps/vscode-languageserver-types/main.js'),
          t = require('../jsonLanguageTypes.js'),
          o = a(require('../../../fillers/vscode-nls.js')),
          i = require('../utils/objects.js');
        function n() {
          if ('function' != typeof WeakMap) return null;
          var e = new WeakMap();
          return (
        ...
        var s = o.loadMessageBundle(),
          c = (function() {
            function o(e, r) {
              (this.jsonSchemaService = e), (this.promise = r), (this.validationEnabled = !0);
            }
            return (
              (o.prototype.configure = function(e) {
                e && ((this.validationEnabled = e.validate), (this.commentSeverity = e.allowComments ? void 0 : r.DiagnosticSeverity.Error));
              }),
              (o.prototype.doValidation = function(o, i, n, a) {
                var c = this;
                if (!this.validationEnabled) return this.promise.resolve([]);
                var m = [],
                  d = {},
                  g = function(e) {
                    var r = e.range.start.line + ' ' + e.range.start.character + ' ' + e.message;
                    d[r] || ((d[r] = !0), m.push(e));
                  },
                  h = function(e) {
                    var a = n ? v(n.trailingCommas) : r.DiagnosticSeverity.Error,
                      l = n ? v(n.comments) : c.commentSeverity;
                    if (e) {
                      if (e.errors.length && i.root) {
                        var d = i.root,
                          h = 'object' === d.type ? d.properties[0] : null;
                        if (h && '$schema' === h.keyNode.value) {
                          var p = h.valueNode || h,
                            y = r.Range.create(o.positionAt(p.offset), o.positionAt(p.offset + p.length));
                          g(r.Diagnostic.create(y, e.errors[0], r.DiagnosticSeverity.Warning, t.ErrorCode.SchemaResolveError));
                        } else {
                          y = r.Range.create(o.positionAt(d.offset), o.positionAt(d.offset + 1));
                          g(r.Diagnostic.create(y, e.errors[0], r.DiagnosticSeverity.Warning, t.ErrorCode.SchemaResolveError));
                        }
                      } else {
                        var S = i.validate(o, e.schema);
                        S && S.forEach(g);
                      }
                      f(e.schema) && (l = void 0), u(e.schema) && (a = void 0);
                    }
                    for (var j = 0, O = i.syntaxErrors; j < O.length; j++) {
                      var b = O[j];
                      if (b.code === t.ErrorCode.TrailingComma) {
                    ...
                    if ('number' == typeof l) {
                      var C = s('InvalidCommentToken', 'Comments are not permitted in JSON.');
                      i.comments.forEach(function(e) {
                        g(r.Diagnostic.create(e, C, l, t.ErrorCode.CommentNotPermitted));
                      });
                    }
                    return m;
                  };
                if (a) {
                  var p = a.id || 'schemaservice://untitled/' + l++;
                  return this.jsonSchemaService.resolveSchemaContent(new e.UnresolvedSchema(a), p, {}).then(function(e) {
                    return h(e);
                  });
                }
                return this.jsonSchemaService.getSchemaForResource(o.uri, i).then(function(e) {
                  return h(e);
                });
              }),
              o
        ...
        exports.JSONValidation = c;
        var l = 0;
        function f(e) {
          if (e && 'object' == typeof e) {
            if ((0, i.isBoolean)(e.allowComments)) return e.allowComments;
            if (e.allOf)
              for (var r = 0, t = e.allOf; r < t.length; r++) {
                var o = f(t[r]);
                if ((0, i.isBoolean)(o)) return o;
              }
          }
        }
        function u(e) {
          if (e && 'object' == typeof e) {
            if ((0, i.isBoolean)(e.allowsTrailingCommas)) return e.allowsTrailingCommas;
            if (e.allOf)
              for (var r = 0, t = e.allOf; r < t.length; r++) {
                var o = u(t[r]);
                if ((0, i.isBoolean)(o)) return o;
    ...
    cmZM: [
      function(require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.hexDigit = c),
          (exports.colorFromHex = d),
          (exports.colorFrom256RGB = h);
        var e = 48,
          r = 57,
          t = 65,
          a = 97,
          o = 102;
        function c(c) {
          return c < e ? 0 : c <= r ? c - e : (c < a && (c += a - t), c >= a && c <= o ? c - a + 10 : 0);
        }
        function d(e) {
          if ('#' !== e[0]) return null;
          switch (e.length) {
            case 4:
              return {
                red: (17 * c(e.charCodeAt(1))) / 255,
                green: (17 * c(e.charCodeAt(2))) / 255,
                blue: (17 * c(e.charCodeAt(3))) / 255,
                alpha: 1
              };
            case 5:
              return {
                ...
                green: (17 * c(e.charCodeAt(2))) / 255,
                blue: (17 * c(e.charCodeAt(3))) / 255,
                alpha: (17 * c(e.charCodeAt(4))) / 255
              };
            case 7:
              return {
                red: (16 * c(e.charCodeAt(1)) + c(e.charCodeAt(2))) / 255,
                green: (16 * c(e.charCodeAt(3)) + c(e.charCodeAt(4))) / 255,
                blue: (16 * c(e.charCodeAt(5)) + c(e.charCodeAt(6))) / 255,
                alpha: 1
              };
            case 9:
              return {
                ...
                green: (16 * c(e.charCodeAt(3)) + c(e.charCodeAt(4))) / 255,
                blue: (16 * c(e.charCodeAt(5)) + c(e.charCodeAt(6))) / 255,
                alpha: (16 * c(e.charCodeAt(7)) + c(e.charCodeAt(8))) / 255
              };
          }
          return null;
        }
        function h(e, r, t, a) {
          return void 0 === a && (a = 1), { red: e / 255, green: r / 255, blue: t / 255, alpha: a };
        }
      },
      {}
    ],
    ODmm: [
      function(require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.JSONDocumentSymbols = void 0);
        var e = i(require('../parser/jsonParser.js')),
          r = i(require('../utils/strings.js')),
          t = require('../utils/colors.js'),
          n = require('../_deps/vscode-languageserver-types/main.js');
        function o() {
          if ('function' != typeof WeakMap) return null;
          var e = new WeakMap();
        ...
        var a = (function() {
          ...
          return (
            (o.prototype.findDocumentSymbols = function(t, o) {
              var i = this,
                a = o.root;
              if (!a) return null;
              var s = t.uri;
              if (
                ('vscode://defaultsettings/keybindings.json' === s || r.endsWith(s.toLowerCase(), '/user/keybindings.json')) &&
                'array' === a.type
              ) {
                var c = [];
                return (
                  a.items.forEach(function(r) {
                    if ('object' === r.type)
                      for (var o = 0, i = r.properties; o < i.length; o++) {
                        var a = i[o];
                        if ('key' === a.keyNode.value && a.valueNode) {
                          if (a.valueNode) {
                            var s = n.Location.create(t.uri, u(t, r));
                            c.push({ name: e.getNodeValue(a.valueNode), kind: n.SymbolKind.Function, location: s });
                          }
                          return;
                        }
                      }
                  ...
                  'array' === r.type
                    ...
                    : 'object' === r.type &&
                      r.properties.forEach(function(r) {
                        var a = n.Location.create(t.uri, u(t, r)),
                          s = r.valueNode;
                        if (s) {
                          var c = o ? o + '.' + r.keyNode.value : r.keyNode.value;
                          e.push({ name: i.getKeyLabel(r), kind: i.getSymbolKind(s.type), location: a, containerName: o }), l(e, s, c);
                        }
                      }),
                  e
                );
            ...
            (o.prototype.findDocumentSymbols2 = function(t, o) {
              var i = this,
                a = o.root;
              if (!a) return null;
              var s = t.uri;
                ...
                return (
                  a.items.forEach(function(r) {
                    if ('object' === r.type)
                      for (var o = 0, i = r.properties; o < i.length; o++) {
                        var a = i[o];
                        if ('key' === a.keyNode.value) {
                          if (a.valueNode) {
                            var s = u(t, r),
                              l = u(t, a.keyNode);
                            c.push({ name: e.getNodeValue(a.valueNode), kind: n.SymbolKind.Function, range: s, selectionRange: l });
                          }
                          return;
                        }
                      }
              ...
              var l = function(e, r) {
                return (
                  'array' === r.type
                    ? r.items.forEach(function(r, n) {
                        if (r) {
                          var o = u(t, r),
                            a = o,
                            s = String(n),
                            c = l([], r);
                          e.push({ name: s, kind: i.getSymbolKind(r.type), range: o, selectionRange: a, children: c });
                        }
                      })
                    : 'object' === r.type &&
                      r.properties.forEach(function(r) {
                        ...
                        if (n) {
                          var o = u(t, r),
                            a = u(t, r.keyNode),
                            s = l([], n);
                          e.push({ name: i.getKeyLabel(r), kind: i.getSymbolKind(n.type), range: o, selectionRange: a, children: s });
                        }
                      }),
                  e
                );
            ...
            (o.prototype.getSymbolKind = function(e) {
              switch (e) {
                case 'object':
                  return n.SymbolKind.Module;
                case 'string':
                  return n.SymbolKind.String;
                case 'number':
                  return n.SymbolKind.Number;
                case 'array':
                  return n.SymbolKind.Array;
                case 'boolean':
                  return n.SymbolKind.Boolean;
                default:
                  return n.SymbolKind.Variable;
              }
            }),
            (o.prototype.getKeyLabel = function(e) {
              var r = e.keyNode.value;
              return r && (r = r.replace(/[\n]/g, '↵')), r && r.trim() ? r : '"' + r + '"';
            }),
            (o.prototype.findDocumentColors = function(r, n) {
              return this.schemaService.getSchemaForResource(r.uri, n).then(function(o) {
                var i = [];
                if (o)
                  for (var a = {}, s = 0, c = n.getMatchingSchemas(o.schema); s < c.length; s++) {
                    var l = c[s];
                    if (
                      !l.inverted &&
                      l.schema &&
                      ...
                      if (!a[f]) {
                        var d = (0, t.colorFromHex)(e.getNodeValue(l.node));
                        if (d) {
                          var y = u(r, l.node);
                          i.push({ color: d, range: y });
                        }
                        a[f] = !0;
                      }
                    }
            ...
            (o.prototype.getColorPresentations = function(e, r, t, o) {
              var i,
                a = [],
                u = Math.round(255 * t.red),
                s = Math.round(255 * t.green),
                c = Math.round(255 * t.blue);
              function l(e) {
                var r = e.toString(16);
                return 2 !== r.length ? '0' + r : r;
              }
              return (
                (i = 1 === t.alpha ? '#' + l(u) + l(s) + l(c) : '#' + l(u) + l(s) + l(c) + l(Math.round(255 * t.alpha))),
                a.push({ label: i, textEdit: n.TextEdit.replace(o, JSON.stringify(i)) }),
                a
              );
            }),
            o
        ...
        function u(e, r) {
          return n.Range.create(e.positionAt(r.offset), e.positionAt(r.offset + r.length));
        }
        exports.JSONDocumentSymbols = a;
      },
      {
        '../parser/jsonParser.js': 'KNHO',
        '../utils/strings.js': 'PlBB',
        '../utils/colors.js': 'cmZM',
        '../_deps/vscode-languageserver-types/main.js': 'gSd8'
      }
    ],
    d6qm: [
      function(require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.schemaContributions = void 0);
        var e = i(require('../../../fillers/vscode-nls.js'));
        function t() {
          if ('function' != typeof WeakMap) return null;
          var e = new WeakMap();
          return (
          ...
          if (null != e) {
            ...
            for (var s in e)
              if (Object.prototype.hasOwnProperty.call(e, s)) {
                ...
                r && (r.get || r.set) ? Object.defineProperty(n, s, r) : (n[s] = e[s]);
              }
          }
          return (n.default = e), i && i.set(e, n), n;
        }
        var n = e.loadMessageBundle(),
          a = {
            schemaAssociations: {},
            schemas: {
        ...
        var s = {
          ...
          description: n('schema.json.description', 'A long description of the element. Used in hover menus and suggestions.'),
          default: n('schema.json.default', 'A default value. Used by suggestions.'),
          multipleOf: n('schema.json.multipleOf', 'A number that should cleanly divide the current value (i.e. have no remainder).'),
          ...
          pattern: n('schema.json.pattern', 'A regular expression to match the string against. It is not implicitly anchored.'),
          additionalItems: n(
          ...
          required: n('schema.json.required', 'An array of strings that lists the names of all properties required on this object.'),
          ...
          definitions: n('schema.json.definitions', 'Not used for validation. Place subschemas here that you wish to reference inline with $ref.'),
          properties: n('schema.json.properties', 'A map of property names to schemas for each property.'),
          patternProperties: n('schema.json.patternProperties', 'A map of regular expressions on property names to schemas for matching properties.'),
          dependencies: n(
          ...
          readOnly: n('schema.json.readOnly', 'Indicates that the value of the instance is managed exclusively by the owning authority.'),
          examples: n('schema.json.examples', 'Sample JSON values associated with a particular schema, for the purpose of illustrating usage.'),
          contains: n(
          ...
          const: n('schema.json.const', 'An instance validates successfully against this keyword if its value is equal to the value of the keyword.'),
          ...
          if: n('schema.json.if', 'The validation outcome of the "if" subschema controls which of the "then" or "else" keywords are evaluated.'),
        ...
        for (var r in a.schemas) {
          var o = a.schemas[r];
          for (var m in o.properties) {
            var f = o.properties[m];
            !0 === f && (f = o.properties[m] = {});
            var l = s[m];
            l ? (f.description = l) : console.log(m + ": localize('schema.json." + m + '\', "")');
          }
        }
      },
      { '../../../fillers/vscode-nls.js': 'M4HU' }
    ...
    fHZF: [
      function(require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.getFoldingRanges = i);
        var e = require('../_deps/vscode-languageserver-types/main.js'),
          n = require('../../jsonc-parser/main.js'),
          t = require('../jsonLanguageTypes.js');
        function i(i, r) {
          var s = [],
            a = [],
            o = [],
            g = -1,
            f = (0, n.createScanner)(i.getText(), !1),
            l = f.scan();
          function d(e) {
            s.push(e), a.push(o.length);
          }
          for (; 17 !== l; ) {
            switch (l) {
              case 1:
              case 3:
                var c = { startLine: (h = i.positionAt(f.getTokenOffset()).line), endLine: h, kind: 1 === l ? 'object' : 'array' };
                o.push(c);
                break;
              case 2:
              case 4:
                var p = 2 === l ? 'object' : 'array';
                if (o.length > 0 && o[o.length - 1].kind === p) {
                  c = o.pop();
                  var u = i.positionAt(f.getTokenOffset()).line;
                  c && u > c.startLine + 1 && g !== c.startLine && ((c.endLine = u - 1), d(c), (g = c.startLine));
                }
                break;
              case 13:
                var h = i.positionAt(f.getTokenOffset()).line,
                  k = i.positionAt(f.getTokenOffset() + f.getTokenLength()).line;
                1 === f.getTokenError() && h + 1 < i.lineCount
                  ? f.setPosition(i.offsetAt(e.Position.create(h + 1, 0)))
                  : h < k && (d({ startLine: h, endLine: k, kind: t.FoldingRangeKind.Comment }), (g = h));
                break;
              case 12:
                var L = i
                  .getText()
                  .substr(f.getTokenOffset(), f.getTokenLength())
                  .match(/^\/\/\s*#(region\b)|(endregion\b)/);
                if (L) {
                  u = i.positionAt(f.getTokenOffset()).line;
                  if (L[1]) {
                    c = { startLine: u, endLine: u, kind: t.FoldingRangeKind.Region };
                    o.push(c);
                  } else {
                    for (var v = o.length - 1; v >= 0 && o[v].kind !== t.FoldingRangeKind.Region; ) v--;
                    if (v >= 0) {
                      c = o[v];
                      (o.length = v), u > c.startLine && g !== c.startLine && ((c.endLine = u), d(c), (g = c.startLine));
                    }
                  }
                }
            }
          ...
          if ('number' != typeof b || s.length <= b) return s;
          for (var T = [], j = 0, m = a; j < m.length; j++) {
            (x = m[j]) < 30 && (T[x] = (T[x] || 0) + 1);
          }
          var y = 0,
            O = 0;
          ...
          for (v = 0; v < s.length; v++) {
            var x;
            'number' == typeof (x = a[v]) && (x < O || (x === O && y++ < b)) && R.push(s[v]);
          }
          return R;
        }
      },
      { '../_deps/vscode-languageserver-types/main.js': 'gSd8', '../../jsonc-parser/main.js': 'RBdm', '../jsonLanguageTypes.js': 'QWB0' }
    ],
    Oovu: [
      function(require, module, exports) {
        'use strict';
        ...
        var e = require('../_deps/vscode-languageserver-types/main.js'),
          t = require('../../jsonc-parser/main.js');
        function r(r, n, s) {
          function a(t, n) {
            return e.Range.create(r.positionAt(t), r.positionAt(n));
          }
          var o = (0, t.createScanner)(r.getText(), !0);
          function f(e, t) {
            return o.setPosition(e), o.scan() === t ? o.getTokenOffset() + o.getTokenLength() : -1;
          }
          return n.map(function(t) {
            for (var n = r.offsetAt(t), o = s.getNodeFromOffset(n, !0), c = []; o; ) {
              switch (o.type) {
                case 'string':
                case 'object':
                case 'array':
                  var i = o.offset + 1,
                    p = o.offset + o.length - 1;
                  i < p && n >= i && n <= p && c.push(a(i, p)), c.push(a(o.offset, o.offset + o.length));
                  break;
                case 'number':
                case 'boolean':
                case 'null':
                case 'property':
                  c.push(a(o.offset, o.offset + o.length));
              }
              if ('property' === o.type || (o.parent && 'array' === o.parent.type)) {
                var u = f(o.offset + o.length, 5);
                -1 !== u && c.push(a(o.offset, u));
              }
              o = o.parent;
            }
            for (var g = void 0, l = c.length - 1; l >= 0; l--) g = e.SelectionRange.create(c[l], g);
            return g || (g = e.SelectionRange.create(e.Range.create(t, t))), g;
          });
        }
      },
      { '../_deps/vscode-languageserver-types/main.js': 'gSd8', '../../jsonc-parser/main.js': 'RBdm' }
    ],
    ozjs: [
      function(require, module, exports) {
        'use strict';
        ...
        (exports.getLanguageService = p),
          ...
          Object.defineProperty(exports, 'CompletionItem', {
            enumerable: !0,
            get: function() {
              return t.CompletionItem;
            }
          }),
          Object.defineProperty(exports, 'CompletionList', {
            enumerable: !0,
            get: function() {
              return t.CompletionList;
            }
          }),
          ...
          Object.defineProperty(exports, 'FormattingOptions', {
            enumerable: !0,
            get: function() {
              return t.FormattingOptions;
            }
          }),
          Object.defineProperty(exports, 'MarkedString', {
            enumerable: !0,
            get: function() {
              return t.MarkedString;
            }
          });
        var t = require('./_deps/vscode-languageserver-types/main.js'),
          n = require('./services/jsonCompletion.js'),
          o = require('./services/jsonHover.js'),
          r = require('./services/jsonValidation.js'),
          i = require('./services/jsonDocumentSymbols.js'),
          s = require('./parser/jsonParser.js'),
          c = require('./services/configuration.js'),
          u = require('./services/jsonSchemaService.js'),
          a = require('./services/jsonFolding.js'),
          m = require('./services/jsonSelectionRanges.js'),
          l = require('../jsonc-parser/main.js'),
          f = require('./jsonLanguageTypes.js');
        function p(e) {
          var f = e.promiseConstructor || Promise,
            p = new u.JSONSchemaService(e.schemaRequestService, e.workspaceContext, f);
          p.setSchemaContributions(c.schemaContributions);
          var d = new n.JSONCompletion(p, e.contributions, f, e.clientCapabilities),
            g = new o.JSONHover(p, e.contributions, f),
            b = new i.JSONDocumentSymbols(p),
            S = new r.JSONValidation(p, f);
          return {
            ...
            parseJSONDocument: function(e) {
              return (0, s.parse)(e, { collectComments: !0 });
            },
            newJSONDocument: function(e, t) {
              return (0, s.newJSONDocument)(e, t);
            },
            doResolve: d.doResolve.bind(d),
            doComplete: d.doComplete.bind(d),
            findDocumentSymbols: b.findDocumentSymbols.bind(b),
            findDocumentSymbols2: b.findDocumentSymbols2.bind(b),
            findColorSymbols: function(e, t) {
              return b.findDocumentColors(e, t).then(function(e) {
                return e.map(function(e) {
                  return e.range;
                });
              });
            },
            findDocumentColors: b.findDocumentColors.bind(b),
            getColorPresentations: b.getColorPresentations.bind(b),
            ...
            format: function(e, n, o) {
              var r = void 0;
              if (n) {
                var i = e.offsetAt(n.start);
                r = { offset: i, length: e.offsetAt(n.end) - i };
              }
              var s = { tabSize: o ? o.tabSize : 4, insertSpaces: !o || o.insertSpaces, eol: '\n' };
              return (0, l.format)(e.getText(), r, s).map(function(n) {
                return t.TextEdit.replace(t.Range.create(e.positionAt(n.offset), e.positionAt(n.offset + n.length)), n.content);
              });
            }
          };
        }
      ...
      {
        './_deps/vscode-languageserver-types/main.js': 'gSd8',
        './services/jsonCompletion.js': 'IScR',
        './services/jsonHover.js': 'fp31',
        './services/jsonValidation.js': 'UH1L',
        './services/jsonDocumentSymbols.js': 'ODmm',
        './parser/jsonParser.js': 'KNHO',
        './services/configuration.js': 'd6qm',
        './services/jsonSchemaService.js': 'VtNB',
        './services/jsonFolding.js': 'fHZF',
        './services/jsonSelectionRanges.js': 'Oovu',
        '../jsonc-parser/main.js': 'RBdm',
        './jsonLanguageTypes.js': 'QWB0'
      }
    ],
    ...
    TfJB: [
      function(require, module, exports) {
        'use strict';
        Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.create = a), (exports.JSONWorker = void 0);
        var e,
          t = o(require('./_deps/vscode-json-languageservice/jsonLanguageService.js')),
          r = o(require('./_deps/vscode-languageserver-types/main.js'));
        function n() {
          if ('function' != typeof WeakMap) return null;
          var e = new WeakMap();
          return (
          ...
          u = (function() {
            function n(r, n) {
              (this._ctx = r),
                ...
                (this._languageService = t.getLanguageService({ schemaRequestService: n.enableSchemaRequest && e, promiseConstructor: i })),
                this._languageService.configure(this._languageSettings);
            }
            return (
              (n.prototype.doValidation = function(e) {
        ...
        exports.JSONWorker = u;
      },
      { './_deps/vscode-json-languageservice/jsonLanguageService.js': 'ozjs', './_deps/vscode-languageserver-types/main.js': 'vCc8' }
    ],
    cogc: [
      function(require, module, exports) {
        'use strict';
        var e = n(require('../../editor/editor.worker.js')),
          r = require('./jsonWorker.js');
        function t() {
          if ('function' != typeof WeakMap) return null;
          var e = new WeakMap();
          return (
        ...
        self.onmessage = function() {
          e.initialize(function(e, t) {
            return new r.JSONWorker(e, t);
          });
        };
      },
      { '../../editor/editor.worker.js': 'Cd57', './jsonWorker.js': 'TfJB' }
    ]
  },
  {},
  ['cogc'],
